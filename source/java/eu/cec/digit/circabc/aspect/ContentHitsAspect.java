...
public class ContentHitsAspect implements
	...
	public void initialise() {
		...
		this.policyComponent.bindClassBehaviour(
				ContentServicePolicies.ON_CONTENT_READ, ASPECT_CONTENT_HITS,
				new JavaBehaviour(this, "onContentRead",
						NotificationFrequency.TRANSACTION_COMMIT));
		this.policyComponent.bindClassBehaviour(
				ContentServicePolicies.ON_CONTENT_UPDATE, ASPECT_CONTENT_HITS,
	 ...
	 *
	 * Sets the count started date to the date/time at which the contentHits
	 * aspect was first applied.
	 *
	 * @param nodeRef
	 *           the node reference
	...
	private class ContentHitsTransactionListener extends
		...
		public void afterCommit() {
			...
			@SuppressWarnings("unchecked")
			final Set<NodeRef> readNodeRefs = (Set<NodeRef>) AlfrescoTransactionSupport
					.getResource(KEY_CONTENT_HITS_READS);
			if (readNodeRefs != null) {
				Runnable runnable;
			...
			@SuppressWarnings("unchecked")
			final Set<NodeRef> writeNodeRefs = (Set<NodeRef>) AlfrescoTransactionSupport
					.getResource(KEY_CONTENT_HITS_WRITES);
