...
public interface IGRootProfileManagerService extends ProfileManagerService
{
	...
	{
		/**
		 * The profile name IGLEADER can never be added, removed or changed The
		 * profile IGLEADER is created during the interestgroup creation process
		 * Must always exist
		 */
		public static final String IGLEADER = "IGLeader";
		
		public static final String LEADER000 = "000";
	...
	public interface Roles
	{
		 ...
		 */
		public static final String IGLEADER = "ROLE_IGLEADER";
	}

	public static String SERVICE_NAME = "igRootProfileManagerService";

	public static String PROXIED_SERVICE_NAME = "IGRootProfileManagerService";
	...
	@NotAuditable
	abstract public QName getContactParamName();
