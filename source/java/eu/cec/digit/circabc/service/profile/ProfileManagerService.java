...
{
	public static final String ALL_CIRCA_USERS_PROFILE_NAME = "EVERYONE";
	public static final String SUPPORT_GROUP_NAME = "CIRCABC_SUPPORT";
	...
	@NotAuditable
	public void setProfileMapCache(final SimpleCache<String, Map<String, Profile>> profileMapCache);
	...
	public void addApplicantPerson(final NodeRef rootNode, final String userID, final String message, final String firstName, final String lastName);
	 ...
	 */
	@Auditable(/*key = Auditable.Key.ARG_0, */parameters = {"rootNode", "userID", "message", "firstName", "lastName"})
	public void addApplicantPerson(final NodeRef rootNode, final String userID, final String message, final String firstName, final String lastName, final Date date);
	 ...
	 * @throws Exception
	 */
	@Auditable(/*key = Auditable.Key.ARG_0, */parameters =
	{ "nodeRef", "profileName", "profVal" })
	public void addProfile(final NodeRef nodeRef, final String profileName,
			final Map<String, Set<String>> profVal) throws ProfileException;
	 ...
	 * 			  alfresco group binded to the profile (optional)
	 * @param nodeRef
	 *            root node
	 * @param title
	 * 			  profile title (multilingual)
	 * @param description
	 * 			  profile description (multilingual)
	 * @param profVal
	 *            HashMap containing the coples (service1,permission in
	 *            service),(service2, permission in service)
	 * @throws Exception
	...
	public void addProfile(final NodeRef nodeRef, final String profileName, final String authorityGroupName, final MLText title, final MLText description, final Map<String, Set<String>> servicesPermissions) throws ProfileException;
	...
	public void renameProfile(final NodeRef nodeRef, final String oldProfileName,
			final String newProfileName) throws ProfileException;
	...
	public Profile updateProfile(final NodeRef nodeRef, final String profileName,
			final Map<String, Set<String>> profVal, boolean updateProfileMap) throws ProfileException;
	...
	public void addPersonToProfile(final NodeRef nodeRef, final String userID,
			final String profileName) throws ProfileException;
	...
	@Auditable(/*key = Auditable.Key.ARG_0, */parameters =
	{ "nodeRef", "userID", "profileName" })
	public void changePersonProfile(final NodeRef nodeRef, final String userID,
			final String profileName) throws ProfileException;
	...
	/**
	 * Return the profile map. The keys in the first map are the profile names
	 * for the rootNodeRef (rows of the array). Then the sub element contain the
	 ...
	 */
	@NotAuditable
	public Set<String> getPersonInProfile(final NodeRef nodeRef,
	 ...
	 */
	@NotAuditable
	public Profile getProfile(final NodeRef nodeRef,
			final String profileName);
	 ...
	 */
	abstract public void importProfile(final NodeRef toIgNoderef, final NodeRef fromIgNoderef, final String fromProfileName, final Map<String, Set<String>> servicesPermissions);
