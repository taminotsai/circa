...
public class ExtensionVariableResolver extends DelegatingVariableResolver
{
    ...
    /**
     * Delegate to the original VariableResolver first, then try to resolve the
     * variable as Spring bean in the root WebApplicationContext.
     */
    ...
    /**
     * Check if the scope of the property value is valid for a bean to be stored
     * in targetScope.
     * 
     * @param facesContext
     * @param property
     ...
     * @param targetScope
     *            name of the target scope of the bean under construction
     */
