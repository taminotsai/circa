...
public class BulkDownloadServlet extends BaseServlet
{
      ...
      throws ServletException, IOException
   {
      ...
      final String bulkDownloadFile = (String) session.getAttribute(CircabcConstant.BULK_DOWNLOAD_FILE); 
         ...
         throws ServletException, IOException
   {
      ...
      if (zipFilePath.contains("..") || !zipFilePath.contains("bulk") || !zipFilePath.endsWith(".zip"))
	  {
    	  if (logger.isErrorEnabled())
    	  {
      ...
      try
      {
         ...
         catch (final ContentIOException e2)
         {
            if (logger.isInfoEnabled())
               logger.info("Client aborted stream read:\n\tnode: " + zipFilePath + "\n\tcontent: " + reader);
         }
