...
public class NotificationStatusPanel implements Serializable
{
	...
	public final String getUserNotificationStatus()
	{
		...
		{
			return NotificationUtils.translateStatus(notificationReport.getUserNotificationStatus()).toUpperCase();
		}
	}
	...
	public final String getProfileNotificationStatus()
	{
		...
		{
			return NotificationUtils.translateStatus(notificationReport.getProfileNotificationStatus()).toUpperCase();
		}
	}
	...
	public final String getGlobalNotificationStatus()
	{
		...
		{
			return NotificationUtils.translateStatus(notificationReport.getGlobalNotificationStatus()).toUpperCase();
		}
	}
	...
	public final String getProfile()
	{
		...
		{
			return ProfileUtils.getProfilename(notificationReport.getLocation(), notificationReport.getUserProfile(), getProfileManagerServiceFactory().getIGRootProfileManagerService(), getManagementService());
		}
	}
	 ...
	 */
	public final void setNotificationSubscriptionService(final NotificationSubscriptionService notificationSubscriptionService)
	{
