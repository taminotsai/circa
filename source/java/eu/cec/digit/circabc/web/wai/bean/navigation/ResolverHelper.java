...
public abstract class ResolverHelper
{
	...
	public static final NavigableNode createContentRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
	...
	public static final NavigableNode createFileLinkRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
		//only display the user has the permissions to navigate to the target of the link
		final NodeRef destRef = (NodeRef) fileInfo.getProperties().get(ContentModel.PROP_LINK_DESTINATION);
	...
	public static final NavigableNode createFolderLinkRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
		//	only display the user has the permissions to navigate to the target of the link
		final NodeRef destRef = (NodeRef)fileInfo.getProperties().get(ContentModel.PROP_LINK_DESTINATION);
        if (destRef != null && new Node(destRef).hasPermission(PermissionService.READ) == true)
	...
	public static final NavigableNode createFolderRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
		// create our Node representation
		final NavigableNode node = buildNode(fileInfo, nodeService);
		addFolderRepresentation(node, browseBean);
	...
	public static final NavigableNode createForumRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
		//create our Node representation
		final NavigableNode node = buildNode(fileInfo, nodeService);
	...
	public static final NavigableNode createTopicRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
		//create our Node representation
		final NavigableNode node = buildNode(fileInfo, nodeService);
	...
	public static final NavigableNode createPostRepresentation(final FileInfo fileInfo, final NodeService nodeService, final CircabcBrowseBean browseBean)
	{
		//create our Node representation
		final NavigableNode node = buildNode(fileInfo, nodeService);
	...
	private static final void addFolderRepresentation(final NavigableNode node, final CircabcBrowseBean browseBean)
	{
	...
	private static final void addContentRepresentation(final NavigableNode node, final CircabcBrowseBean browseBean, final boolean isLink)
	{
	...
	private static final void addForumRepresentation(final NavigableNode node, final CircabcBrowseBean browseBean)
	{
		node.addPropertyResolver(DISPLAY_PATH, browseBean.resolverSimpleDisplayPath);
		node.addPropertyResolver(DISPLAY_LIGTH_PATH, browseBean.resolverSimpleDisplayPathLight);
	...
	private static final void addTopicRepresentation(final NavigableNode node, final CircabcBrowseBean browseBean)
	{
		node.addPropertyResolver(DISPLAY_PATH, browseBean.resolverSimpleDisplayPath);
		node.addPropertyResolver(DISPLAY_LIGTH_PATH, browseBean.resolverSimpleDisplayPathLight);
	...
	private static final void addPostRepresentation(final NavigableNode node, final CircabcBrowseBean browseBean)
	{
		addContentRepresentation(node, browseBean, false);
