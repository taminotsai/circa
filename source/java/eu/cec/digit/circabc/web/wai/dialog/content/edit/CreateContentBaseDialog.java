...
public abstract class CreateContentBaseDialog extends BaseWaiDialog
{
    ...
    protected String getSelectedContent()
    {
        ...
        {
            throw new IllegalStateException("Unknow mode: " + editMode + ". One of these expected: " + MODE_TEXT + ", " + MODE_HTML);
        }
    }
    ...
    protected String doPostCommitProcessing(FacesContext context, String outcome)
    {
        ...
        else if(reopen())
        {
            ...
            return CircabcNavigationHandler.CLOSE_WAI_DIALOG_OUTCOME
                    ...
                    + (isDialog() ? CircabcNavigationHandler.WAI_DIALOG_PREFIX : CircabcNavigationHandler.WAI_WIZARD_PREFIX)
                    + getDialogName();
        }
        else
        {
    ...
    protected String getContent(final NodeRef nodeRef) throws InvalidNodeRefException, InvalidTypeException, ContentIOException
    {
    ...
    public void setDefaultMode(final String ignore)
    {
        // do nothing, just for jsf setter
    }
    	...
    	try
    	{
    		 final AttachementWrapper wrapper = (AttachementWrapper) this.attachmentDataModel.getRowData();
	   		 ...
	   		 if(wrapper.isCreated())
	   		 {
	   			 ...
	   			 getAttachementBusinessSrv().removeAttachement(getEditablePost(), wrapper.getAttachement().getNodeRef());
	   		 ...
	   		 else
	   		 {
	   			 if(wrapper.isLink == false)
	   			 {
	   				 ...
	   				 final ChildAssociationRef tempRoot = getNodeService().getPrimaryParent(wrapper.getAttachRef());
	   				AuthenticationUtil.setRunAsUserSystem();
	   				 getAttachementBusinessSrv().removeAttachement(tempRoot.getParentRef(), wrapper.getAttachRef());
    ...
    public void setAttachFile(String name)
    {
        ...
        final FileUploadBean fileBean = (FileUploadBean)ctx.getExternalContext().getSessionMap().get(FileUploadBean.FILE_UPLOAD_BEAN_NAME);

        if (fileBean != null && fileBean.getFile() != null)
        {
        	final NodeRef tempAttach = getAttachementBusinessSrv().addTempAttachement(name, fileBean.getFile());
    ...
    protected void clearUpload()
    {
    	...
    	attachementWrappers = new ArrayList<AttachementWrapper>();
    }
    ...
    public static class AttachementWrapper implements Serializable
    {
        ...
        private AttachementWrapper(final NodeRef attachRef, final String name, boolean isLink)
        {
        	super();
            this.name = name;
