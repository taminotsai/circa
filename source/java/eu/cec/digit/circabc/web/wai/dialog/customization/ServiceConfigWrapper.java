...
public class ServiceConfigWrapper implements Serializable
{
	...
	/*package*/ ServiceConfigWrapper(DefaultLogoConfiguration configuration, final IGServicesNode service, final List<LogoDefinition> availableImages)
	{
		super();
	...
	/*package*/ final DefaultLogoConfiguration getOriginalConfiguration()
	{
		return configuration;
	}

	/*package*/ final IGServicesNode getService()
	{
		return service;
	}
	...
	{
		final List<SelectItem> items = new ArrayList<SelectItem>(availableImages.size() + 1);
