...
public class NodeLinksDialog extends BaseWaiDialog
{
		...
		if(parameters != null)
		{
			...
			AuthenticationUtil.runAs(new AuthenticationUtil.RunAsWork<Object>()
	        {
	            public Object doWork()
	            {
	    			...
	    			isContent = ContentModel.TYPE_CONTENT.equals(type) || ApplicationModel.TYPE_FILELINK.equals(type) || getDictionaryService().isSubClass(type, ContentModel.TYPE_CONTENT);
	    			isLink = ApplicationModel.TYPE_FOLDERLINK.equals(type)  || ApplicationModel.TYPE_FILELINK.equals(type);
	    			...
	    			final NodeRef rootLogoRef = getMailPreferencesService().getDisclamerLogo(getNavigator().getCircabcHomeNode().getNodeRef());
	    			...
	    			browseUrl = WebClientHelper.getGeneratedWaiRelativeUrl(node, ExtendedURLMode.HTTP_WAI_BROWSE);
	    			...
	    			node.put("description", description == null || description.length() == 0 ? "&nbsp;" : description);
	...
	public String getGeneratedUrl()
	{
		...
		return MessageFormat.format(LINK_PATTERN, linkPrefix, this.urlMode, this.urlTarget, this.urlTitle, imageElem, this.urlText);
	}
