...
public class AuditSearchPagedDialog extends BaseWaiPageableDialog<LogSearchResultDAO>
{
	...
	public void init(Map<String, String> parameters)
	{
		...
		if(resetFields)
		{
			...
			this.dataList = getLogService().searchPage(igID, user, service, activity, fromDate, toDate, this.firstRow ,this.rowsPerPage);
		}
	...
	private void initUsers()
	{
		...
		final Set<String> invitedUsers = igRootProfileManagerService.getInvitedUsers(currentInterestGroup);
   ...
   public boolean isWarningFounds()
   {
    ...
    /**
     * Util activity to fill the map of methods by service according which services and methods already audited
     * in the database.
     */
	...
	public String getFinishButtonLabel()
	{
		...
		// 'Search' if not.
		return (dataList == null) ? bundle.getString(MESSAGE_ID_SEARCH) : bundle.getString(MESSAGE_ID_NEW_SEARCH);
	}
    ...
    public SelectItem[] getActivities()
    {
    	...
    	{
    		activitiesAsList = new ArrayList<String>();
    	...
    	List<SelectItem> activitiesAsItemList = new ArrayList<SelectItem>(activitiesAsList.size());
	 ...
	 */
	public void setActivity(String method)
	{
	...
	@Override
	protected List<LogSearchResultDAO> getList(int firstRow, int rowsPerPage, String sortField, boolean sortAscending)
	{
		if (! isRenderingState() )
		{
			this.dataList = getLogService().searchPage( igID, user, service, activity, fromDate, toDate, this.firstRow ,this.rowsPerPage );
