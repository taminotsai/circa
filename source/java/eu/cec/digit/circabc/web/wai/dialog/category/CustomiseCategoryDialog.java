...
public class CustomiseCategoryDialog extends BaseWaiDialog{
	...
	public void init(Map<String, String> parameters) {
		...
		if(getNodeService().getProperties(currentNode).containsKey(CircabcModel.PROP_NAVIGATION_LIST_RENDER_TYPE))
		{
			selectedRenderChoice= getNodeService().getProperty(currentNode, CircabcModel.PROP_NAVIGATION_LIST_RENDER_TYPE).toString();
		}
	...
	protected String finishImpl(FacesContext context, String outcome)
		...
		Map<QName, Serializable> rendererProperty = new HashMap<QName, Serializable>();
		...
		if(selectedRenderChoice.equals(navigationListShortNameRender) && isCategory)
		{
			 ...
			 */
			rendererProperty.put(CircabcModel.PROP_NAVIGATION_LIST_RENDER_TYPE, navigationListShortNameRender);
		...
		else if (selectedRenderChoice.equals(navigationListTitleRender) && isCategory)
		{
			 ...
			 */
			rendererProperty.put(CircabcModel.PROP_NAVIGATION_LIST_RENDER_TYPE, navigationListTitleRender);
