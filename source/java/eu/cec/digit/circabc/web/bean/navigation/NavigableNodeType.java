...
import static eu.cec.digit.circabc.model.CircabcModel.ASPECT_INFORMATION_ROOT;
...
import static eu.cec.digit.circabc.model.CircabcModel.TYPE_CATEGORY_HEADER;
...
import eu.cec.digit.circabc.web.wai.bean.navigation.CategoryBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.CategoryHeadersBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.DirectoryBean;
...
import eu.cec.digit.circabc.web.wai.bean.navigation.SurveyHomeBean;
...
import eu.cec.digit.circabc.web.wai.bean.navigation.library.DiscussionForumBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.library.DiscussionPostBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.library.DiscussionTopicBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.library.DossierBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.library.FileLinkDetailsBean;
import eu.cec.digit.circabc.web.wai.bean.navigation.library.MLContentDetailsBean;
...
public enum NavigableNodeType
{
	...
	INFORMATION_CHILD (CIRCABC_CHILD, ComparatorType.ASPECT, ASPECT_INFORMATION, InformationBean.BEAN_NAME),
	...
	INFORMATION (INFORMATION_CHILD, ComparatorType.ASPECT, ASPECT_INFORMATION_ROOT, InformationBean.BEAN_NAME),

	LIBRARY_SPACE(LIBRARY_CHILD, ComparatorType.TYPE, ContentModel.TYPE_FOLDER, LibraryBean.BEAN_NAME),
	LIBRARY_DOSSIER(LIBRARY_CHILD, ComparatorType.TYPE, DossierModel.TYPE_DOSSIER_SPACE, DossierBean.BEAN_NAME),
	LIBRARY_CONTENT(LIBRARY_CHILD, ComparatorType.TYPE, ContentModel.TYPE_CONTENT, ContentDetailsBean.BEAN_NAME),
	LIBRARY_EMPTY_TRANSLATION(LIBRARY_CHILD, ComparatorType.ASPECT, ContentModel.ASPECT_MULTILINGUAL_EMPTY_TRANSLATION, ContentDetailsBean.BEAN_NAME),
	LIBRARY_FILE_LINK(LIBRARY_CHILD, ComparatorType.TYPE, ApplicationModel.TYPE_FILELINK, FileLinkDetailsBean.BEAN_NAME),
	LIBRARY_FORUM(LIBRARY_CHILD, ComparatorType.TYPE, ForumModel.TYPE_FORUM, DiscussionForumBean.BEAN_NAME),
	LIBRARY_TOPIC(LIBRARY_CHILD, ComparatorType.TYPE, ForumModel.TYPE_TOPIC, DiscussionTopicBean.BEAN_NAME),
	LIBRARY_POST(LIBRARY_CHILD, ComparatorType.TYPE, ForumModel.TYPE_POST, DiscussionPostBean.BEAN_NAME),

	LIBRARY_ML_CONTENT(ComparatorType.TYPE, ContentModel.TYPE_MULTILINGUAL_CONTAINER, MLContentDetailsBean.BEAN_NAME),
	LIBRARY_ML_CONTENT_TOPIC(ComparatorType.TYPE, ForumModel.TYPE_TOPIC, DiscussionTopicBean.BEAN_NAME),
	LIBRARY_ML_CONTENT_FORUM(ComparatorType.TYPE, ForumModel.TYPE_FORUM, DiscussionForumBean.BEAN_NAME),
	...
	SURVEY_SPACE (SURVEY_CHILD, ComparatorType.TYPE, ContentModel.TYPE_FOLDER, SurveyHomeBean.BEAN_NAME),
	...
	INFORMATION_SPACE(INFORMATION_CHILD, ComparatorType.TYPE, ContentModel.TYPE_FOLDER, InformationBean.BEAN_NAME),
	INFORMATION_CONTENT(INFORMATION_CHILD, ComparatorType.TYPE, ContentModel.TYPE_CONTENT, InfContentDetailsBean.BEAN_NAME),
	INFORMATION_FILE_LINK(INFORMATION_CHILD, ComparatorType.TYPE, ApplicationModel.TYPE_FILELINK, InfFileLinkDetailsBean.BEAN_NAME),
	...
	private NavigableNodeType(final ComparatorType comprator, final QName comparatorQName, final String beanName)
	{
		this(null, comprator, comparatorQName, beanName);
	}

	private NavigableNodeType(final NavigableNodeType requireNodeType, final ComparatorType comprator, final QName comparatorQName, final String beanName)
	{
	...
	/*package */boolean isNodeFromType(final Node node, final boolean resovleParent)
	{
		...
		else if(resovleParent == false || requireNodeType == null || requireNodeType.isNodeFromType(node, resovleParent))
		{
			switch(comparatorType)
			{
            	...
            	case TYPE:
            		...
            		else
            		{
            			...
            			if (typeDef != null)
            			{
            				if (comparatorQName.equals(type) || getDictionaryService().isSubClass(type, comparatorQName))
            				{
            					return true;
            				}
            			}
		...
		else
		{
			switch (otherType)
			{
				...
				case CATEGORY:
					...
					break;
				case IG_ROOT:
					response = !this.equals(CIRCABC_ROOT) && !this.equals(CATEGORY_HEADER) && !this.equals(CATEGORY);
					break;
				case LIBRARY:
					response = this.equals(LIBRARY_CHILD)
									||(this.getRequireNodeType() != null && this.getRequireNodeType().equals(LIBRARY_CHILD))
					...
					break;
				case NEWSGROUP:
					response = this.equals(NEWSGROUP_CHILD) || (this.getRequireNodeType() != null && this.getRequireNodeType().equals(NEWSGROUP_CHILD));
					break;
				case SURVEY:
					response = this.equals(SURVEY_CHILD) || (this.getRequireNodeType() != null && this.getRequireNodeType().equals(SURVEY_CHILD));
					break;
				case INFORMATION:
					response = this.equals(INFORMATION_CHILD) || (this.getRequireNodeType() != null && this.getRequireNodeType().equals(INFORMATION_CHILD));
					break;
				case EVENT:
					response = this.equals(EVENT_CHILD) || (this.getRequireNodeType() != null && this.getRequireNodeType().equals(EVENT_CHILD));
					break;
				case DIRECTORY:
	...
	protected CircabcServiceRegistry getCircabcServiceRegistry()
	{
		...
		{
			this.circabcServiceRegistry = Services.getCircabcServiceRegistry(FacesContext.getCurrentInstance());
		}
