...
public class SurveysBean extends BaseWaiDialog implements IContextListener
{
    ...
    /**
     * Action called from an Action Link component. Launch the encoding of a
     * survey.
     */
    ...
    /**
     * Action called from an Action link component. Close the survey, redirect
     * the user to the survey space
     */
    ...
    /**
     * Adds the specified map to the parameters map. This parameters are sent to
     * IPM
     *
     * @param parameters
     */
