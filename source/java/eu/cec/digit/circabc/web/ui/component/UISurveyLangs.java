 ...
 * ConstantMethodBinding was removed.
...
public class UISurveyLangs extends SelfRenderingComponent
{
    ...
    private void buildLinks(FacesContext context)
    {
        ...
        for (String code: Language.codesList(CommonUtils.getLanguages()))
        {
           ...
           evaluator.setValueBinding(ListContainsEvaluatorTag.ATTR_LIST, facesApp.createValueBinding("#{" + SURVEY_CONTEXT + ".translations}"));
           ...
           control.setValueBinding("value", facesApp.createValueBinding(ipmBaseUrl + "?form=#{" + SURVEY_CONTEXT + ".name}&lang="+ code));
           ...
           HtmlOutputText control3 = (HtmlOutputText) facesApp.createComponent(HtmlOutputText.COMPONENT_TYPE);
           control3.setValue(" ");
