...
public class UINavigationList extends UICommand
{
	...
	public boolean getSeparatorFirst()
	{
		...
		{
			return this.separatorFirst.booleanValue();
		} else
		{
			// return default
			return true;
	...
	{
		this.separatorFirst = Boolean.valueOf(separatorFirst);
	}
...
public void setRenderPropertyName(String renderPropertyName) {
	...
	/** The separatorFirst property which indicate if the separator should be put ahead (default behavior) */
