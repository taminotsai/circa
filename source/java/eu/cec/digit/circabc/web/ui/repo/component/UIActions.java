 ...
 * ConstantMethodBinding was moved to Spring.
 * SelfRenderingComponent was moved to Spring.
 * Some changes between Alfresco versions detected, changed and commented.
 */
public class UIActions extends SelfRenderingComponent
{
	   ...
	   private final List<String> hiddenActions = new ArrayList<String>(12);
	   ...
	   public void encodeChildren(FacesContext context) throws IOException
	   {
	      ...
	      boolean needContainer = ((getAttributes().get(ATTR_STYLE) != null) || (getAttributes().get(ATTR_STYLECLASS) != null)) ? true : false;
	      if (needContainer) {
	    	  out.write("<span ");
	      }
	      ...
	      throws IOException
	   {
	      ...
	      for (String actionId : actionGroup)
	      {
	         ...
	         if(hiddenActions.contains(actionId))
	         {
	        	 if (logger.isDebugEnabled())
...
//	   }
	    ...
	    * 
	    * Migration 3.1 -> 3.4.6 - 02/12/2011
	    * Changed the id generation like in 3.4.6
	    */
	   private static String createUniqueId()
	   {
	      try
