...
public class UserManager
{
	...
	private NodeRef getOrCreateUserPreferencesRef(final NodeRef person, final boolean createIfMissing)
    {
		...
		else
		{
			...
			{
				final List<NodeRef> nodes = searchService.selectNodes(configRef, PREFERENCES_XPATH, null, namespaceService, false);
