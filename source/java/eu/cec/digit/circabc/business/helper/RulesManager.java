...
/**
 * Manage rules and add facilities to create common circabc rules (ie: Add LibraryAspect to all childs, Add content notify aspect, ...)
 *
...
public class RulesManager
{
	...
	public void addAspectToAllChilds(final NodeRef nodeRef, final QName aspectQName, final QName childTypeQName)
	{
		// create the action
		...
		else
		{
			...
			compositeAction.setDescription(compositeAction.getDescription() + " of type " + childTypeQName.getLocalName());
		}
