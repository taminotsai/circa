...
/**
 * Workflow task that is added to the assignments or signatory
 *                 workflow.
 */
public abstract class TaskToAdd  implements java.io.Serializable {
     ...
     * 
     * @return assigneeId   * Current entity id of the internal person
     *                         that has this task assigned. Organizations
     * or
     *                         external persons are not valid assignees.
     */
     ...
     * 
     * @param assigneeId   * Current entity id of the internal person
     *                         that has this task assigned. Organizations
     * or
     *                         external persons are not valid assignees.
     */
     ...
     * 
     * @return instructions   * Optional instructions given by the sender
     *                         to the assignee regarding what has to be done
     * as
     *                         part of this task.
     */
     ...
     * 
     * @param instructions   * Optional instructions given by the sender
     *                         to the assignee regarding what has to be done
     * as
     *                         part of this task.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TaskToAdd)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "TaskToAdd"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("assigneeId");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "assigneeId"));
