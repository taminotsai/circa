...
public class DocumentNotificationsResponse  implements java.io.Serializable {
     ...
     */
    public void setDocumentNotification(eu.cec.digit.circabc.repo.hrs.ws.DocumentNotification[] documentNotification) {
        this.documentNotification = documentNotification;
    }
    ...
    public void setDocumentNotification(int i, eu.cec.digit.circabc.repo.hrs.ws.DocumentNotification _value) {
        this.documentNotification[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentNotificationsResponse)) return false;
        ...
        _equals = true && 
            ...
            ((this.documentNotification==null && other.getDocumentNotification()==null) || 
             (this.documentNotification!=null &&
              java.util.Arrays.equals(this.documentNotification, other.getDocumentNotification())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "DocumentNotificationsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("total");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "total"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("documentNotification");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "documentNotification"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "DocumentNotification"));
