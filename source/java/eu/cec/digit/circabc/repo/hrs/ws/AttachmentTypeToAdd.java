...
public class AttachmentTypeToAdd implements java.io.Serializable {
    ...
    public static final AttachmentTypeToAdd NATIVE_ELECTRONIC = new AttachmentTypeToAdd(_NATIVE_ELECTRONIC);
    ...
    public static AttachmentTypeToAdd fromValue(java.lang.String value)
        ...
        AttachmentTypeToAdd enumeration = (AttachmentTypeToAdd)
            _table_.get(value);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "AttachmentTypeToAdd"));
    }
    /**
