...
public class Document  implements java.io.Serializable {
     ...
     * 
     * @return modificationDate   * Date+Time when the document was last modified. A modification
     * is considered to be any change to the document's metadata, filing,
     * items, senders or recipients.
     */
     ...
     * 
     * @param modificationDate   * Date+Time when the document was last modified. A modification
     * is considered to be any change to the document's metadata, filing,
     * items, senders or recipients.
     */
     ...
     * 
     * @return saverEcasId   * ECAS user name of the user that encoded the document in the
     * common repository. If the user was acting on behalf of somebody else
     * (i.e. by using delegations in Ares), this field
     *                         contains the real user, not the on-behalf-of
     * user (e.g. if a secretary acts
     ...
     * 
     * @param saverEcasId   * ECAS user name of the user that encoded the document in the
     * common repository. If the user was acting on behalf of somebody else
     * (i.e. by using delegations in Ares), this field
     *                         contains the real user, not the on-behalf-of
     * user (e.g. if a secretary acts
     ...
     * 
     * @return registererEcasId   * ECAS user name of the user that registered the document in
     * the
     *                         common repository. If the user was acting
     * on behalf of somebody else, this
     *                         field contains the real user, not the on-behalf-of
     ...
     * 
     * @param registererEcasId   * ECAS user name of the user that registered the document in
     * the
     *                         common repository. If the user was acting
     * on behalf of somebody else, this
     *                         field contains the real user, not the on-behalf-of
     ...
     * 
     * @return createdOnBehalfOf   * User name of the user on whose behalf the document was encoded
     * in the
     *                         common repository. For a user that doesn't
     * use a delegation in Ares when creating the document, this
     *                         field will be the same as saverEcasId. For
     ...
     * 
     * @param createdOnBehalfOf   * User name of the user on whose behalf the document was encoded
     * in the
     *                         common repository. For a user that doesn't
     * use a delegation in Ares when creating the document, this
     *                         field will be the same as saverEcasId. For
     ...
     */
    public void setSecurityClassification(eu.cec.digit.circabc.repo.hrs.ws.SecurityClassification securityClassification) {
        this.securityClassification = securityClassification;
    }
     ...
     * 
     * @return markerDeadline   * Deadline associated to the marker. The marker will expire at
     * this date.
     */
     ...
     * 
     * @param markerDeadline   * Deadline associated to the marker. The marker will expire at
     * this date.
     */
     ...
     * 
     * @return personConcerned   * A recipient of the document to which this document is addressed.
     * This person
     *                     is considered the 'person concerned' and can only
     * be specified using a marker.
     *                     This is element is valid if there is a marker
     ...
     * 
     * @param personConcerned   * A recipient of the document to which this document is addressed.
     * This person
     *                     is considered the 'person concerned' and can only
     * be specified using a marker.
     *                     This is element is valid if there is a marker
     ...
     * not an organization entity. It should not be a virtual entity.
     */
    public void setPersonConcerned(eu.cec.digit.circabc.repo.hrs.ws.DocumentPersonConcerned personConcerned) {
        this.personConcerned = personConcerned;
    }
     ...
     * 
     * @return markerService   * The service specified when the LIMITED_SERVICE marking was
     *                         applied (may be missing for older documents).
     */
     ...
     * 
     * @param markerService   * The service specified when the LIMITED_SERVICE marking was
     *                         applied (may be missing for older documents).
     */
     ...
     * 
     * @return encryptItems   * Indicates whether the content of the items is stored encrypted
     * in
     *                         the repository. In case the content is stored
     * encrypted, the
     *                         decryption will be done automatically when
     ...
     * 
     * @param encryptItems   * Indicates whether the content of the items is stored encrypted
     * in
     *                         the repository. In case the content is stored
     * encrypted, the
     *                         decryption will be done automatically when
     ...
     * 
     * @return frozen   * Indicates if the document is frozen.
     *                     A frozen document cannot be updated any more (even
     * if it's not registered).
     *                     A document becomes frozen when it was filed in
     * a file that has been closed.
     ...
     * 
     * @param frozen   * Indicates if the document is frozen.
     *                     A frozen document cannot be updated any more (even
     * if it's not registered).
     *                     A document becomes frozen when it was filed in
     * a file that has been closed.
     ...
     */
    public void setRecipients(eu.cec.digit.circabc.repo.hrs.ws.DocumentRecipientsRecipient[] recipients) {
        this.recipients = recipients;
    }
     ...
     */
    public void setAssignmentWorkflow(eu.cec.digit.circabc.repo.hrs.ws.AssignmentWorkflow assignmentWorkflow) {
        this.assignmentWorkflow = assignmentWorkflow;
    }
     ...
     */
    public void setSignatoryWorkflow(eu.cec.digit.circabc.repo.hrs.ws.SignatoryWorkflow signatoryWorkflow) {
        this.signatoryWorkflow = signatoryWorkflow;
    }
     ...
     * 
     * @return signedBy   * A list of users that have 'signed' a registered document (i.e.
     * they had a SIGN task in the eSignatory workflow and have closed it).
     * The list is in reverse order compared to the eSignatory order (i.e.
     * the last
     *                         user who signed is first in the list).
     ...
     * 
     * @param signedBy   * A list of users that have 'signed' a registered document (i.e.
     * they had a SIGN task in the eSignatory workflow and have closed it).
     * The list is in reverse order compared to the eSignatory order (i.e.
     * the last
     *                         user who signed is first in the list).
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "Document"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "title"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("mailType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "mailType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "MailType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("documentDate");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "documentDate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "sentDate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "date"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "modificationDate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "saverEcasId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "registererEcasId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "createdOnBehalfOf"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("comments");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "comments"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "securityClassification"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "SecurityClassification"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("markerType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "markerType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "MarkerType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("markerDeadline");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "markerDeadline"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "date"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "personConcerned"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">Document>personConcerned"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("markerService");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "markerService"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "encryptItems"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "encryptItemsDeadline"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "date"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "frozen"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("senders");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "senders"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">>Document>senders>sender"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "sender"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recipients");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "recipients"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">>Document>recipients>recipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "recipient"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("items");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "items"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "Item"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "item"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filedIn");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "filedIn"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">>Document>filedIn>file"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "file"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("links");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "links"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "Link"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "link"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("assignmentWorkflow");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "assignmentWorkflow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "AssignmentWorkflow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("signatoryWorkflow");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "signatoryWorkflow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "SignatoryWorkflow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("procedure");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "procedure"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "Procedure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("signedBy");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "signedBy"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">Document>signedBy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
