...
public class CreateSignatoryRequest  implements java.io.Serializable {
     ...
     * 
     * @return managerId   * The manager of the signatory, which has to be an internal person
     * (i.e. organizations and external entities are not valid workflow managers).
     * This person can perform special actions on the signatory (for now
     * only
     *                         from Ares), like 'Bypass e-Signatory'.
     ...
     * 
     * @param managerId   * The manager of the signatory, which has to be an internal person
     * (i.e. organizations and external entities are not valid workflow managers).
     * This person can perform special actions on the signatory (for now
     * only
     *                         from Ares), like 'Bypass e-Signatory'.
     ...
     * 
     * @return tasks   * List of signatory tasks to be added to the document's signatory
     * workflow. More tasks can be added later if needed, but at least one
     * task
     *                         is needed at creation time.
     */
     ...
     * 
     * @param tasks   * List of signatory tasks to be added to the document's signatory
     * workflow. More tasks can be added later if needed, but at least one
     * task
     *                         is needed at creation time.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateSignatoryRequest)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "CreateSignatoryRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "managerId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "SignatoryTaskToAdd"));
        elemField.setNillable(false);
