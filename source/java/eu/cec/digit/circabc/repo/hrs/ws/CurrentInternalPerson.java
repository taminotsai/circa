...
public class CurrentInternalPerson  implements java.io.Serializable {
     ...
     * 
     * @return id   * Internal repository ID that identifies the internal person
     * / VE
     */
     ...
     * 
     * @param id   * Internal repository ID that identifies the internal person
     * / VE
     */
     ...
     * 
     * @return userName   * Internal user name of the person.
     *                         This user name is also the ECAS user name
     * of the person or the
     *                         VE user name (e.g. ve_123) of the virtual
     * entity.
     ...
     * 
     * @param userName   * Internal user name of the person.
     *                         This user name is also the ECAS user name
     * of the person or the
     *                         VE user name (e.g. ve_123) of the virtual
     * entity.
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CurrentInternalPerson)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "CurrentInternalPerson"));
