...
//           this.encryptItemsDeadline = encryptItemsDeadline;
     ...
     * 
     * @return encryptItems   * Indicates whether the content of the items should be stored
     * encrypted. The
     *                     encryption is done automatically when the content
     * is inserted into the
     *                     repository. No special action is required. Only
...
//    }
     ...
     * 
     * @param encryptItems   * Indicates whether the content of the items should be stored
     * encrypted. The
     *                     encryption is done automatically when the content
     * is inserted into the
     *                     repository. No special action is required. Only
...
//    }
     ...
     * 
     * @return marking   * Marker to be applied to the document according to the security
     * classification
     */
     ...
     * 
     * @param marking   * Marker to be applied to the document according to the security
     * classification
     */
     ...
     */
    public void setRecipients(eu.cec.digit.circabc.repo.hrs.ws.RecipientsToAddRecipient[] recipients) {
        this.recipients = recipients;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentRegistrationRequest)) return false;
...
/*            ((this.encryptItems==null && other.getEncryptItems()==null) || 
            ...
            ((this.marking==null && other.getMarking()==null) || 
             (this.marking!=null &&
              this.marking.equals(other.getMarking()))) &&
...
//        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "DocumentRegistrationRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "marking"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "Marking"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">SendersToAdd>sender"));
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">RecipientsToAdd>recipient"));
        elemField.setNillable(false);
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "uploadedItem"));
        typeDesc.addFieldDesc(elemField);
    }
