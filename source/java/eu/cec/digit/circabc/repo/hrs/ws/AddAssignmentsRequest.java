...
/**
 * Request for adding assignment tasks to a document, by creating
 * or
 *                 updating its assignment workflow.
 */
public class AddAssignmentsRequest  implements java.io.Serializable {
     ...
     * 
     * @return tasks   * List of assignment tasks to be added to the document's assignment
     * workflow.
     */
     ...
     * 
     * @param tasks   * List of assignment tasks to be added to the document's assignment
     * workflow.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddAssignmentsRequest)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "AddAssignmentsRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "AssignmentTaskToAdd"));
        elemField.setNillable(false);
