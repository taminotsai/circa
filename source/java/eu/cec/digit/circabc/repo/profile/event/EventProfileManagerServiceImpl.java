...
public class EventProfileManagerServiceImpl extends
		ProfileManagerServiceImpl implements EventProfileManagerService
{
	...
	private static final Log logger = LogFactory
			.getLog(EventProfileManagerServiceImpl.class);
	...
	public void addProfile(final NodeRef nodeRef, final String profileName, final String authorityGroupName,
			...
			throws ProfileException
	{
		addProfile(nodeRef, profileName, authorityGroupName,
						null, null, profilesPermissions);
	}
