...
ALTER TABLE `alf_access_control_entry` ADD CONSTRAINT `fk_alf_ace_auth` FOREIGN KEY `fk_alf_ace_auth` (`authority_id`)
...
ALTER TABLE `alf_acl_member` ADD CONSTRAINT `fk_alf_aclm_ace` FOREIGN KEY `fk_alf_aclm_ace` (`ace_id`)
