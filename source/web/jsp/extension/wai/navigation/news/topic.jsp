...
<circabc:panel id="contentMainTopic" styleClass="contentMain">
	...
	<circabc:richList id="newsGroupsTopicList" viewMode="circa" styleClass="recordSet" headerStyleClass="recordSetHeader" rowStyleClass="recordSetRow" altRowStyleClass="recordSetRowAlt" value="#{WaiNavigationManager.bean.posts}" var="p" initialSortColumn="created" initialSortDescending="false" pageSize="#{WaiNavigationManager.bean.listPageSize}">
		<circabc:column>
			<f:facet name="header">
		...
		<circabc:column>
			<f:facet name="header">
				<h:outputText value="#{cmsg.author}" escape="false" />
			</f:facet>
			...
			<f:verbatim><br /></f:verbatim>
			<h:outputFormat value="#{cmsg.newsgroups_topic_subject_user_profile}" escape="false" style="font-size:x-small;">
		...
		<circabc:column>
			<f:facet name="header">
				<h:outputFormat value="#{cmsg.newsgroups_topic_subject_message}" escape="false" >
