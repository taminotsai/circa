...
<circabc:panel id="audienceWizardMainForm" styleClass="contentFullPage">
	...
	<circabc:panel id="block-open"  >
		...
		<h:outputText value="#{cmsg.event_create_meetings_wizard_step3_send_details}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="block-closed"  >
		...
		<circabc:panel id="meeting-audience-externalUser-section" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.event_create_meetings_wizard_step3_section1}" escape="false" />
		</circabc:panel>
		<h:outputText value="#{event_create_meetings_wizard_step3_section1_description}" />
		...
		<circabc:panel id="meeting-audience-internalUser-section" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.event_create_meetings_wizard_step3_section2}" escape="false" />
		</circabc:panel>
