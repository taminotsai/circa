...
<circabc:panel id="messagePanel" rendered="#{!WaiDialogManager.bean.allowedToView}">
	<h:outputText value="#{cmsg.view_user_membership_not_allowed}" escape="false"  />
</circabc:panel>

<circabc:panel id="view-user-membership-title" styleClass="signup_rub_title" tooltip="#{cmsg.view_user_membership_header_tooltip}"
	rendered="#{WaiDialogManager.bean.allowedToView}">
	<h:outputText value="#{cmsg.view_user_membership_header}" escape="false"  />
</circabc:panel>
...
<circabc:richList id="categoryRoles" viewMode="circa" 
	...
	<circabc:column id="category-action-column">
		<circabc:actionLink id="view-user-membership-category-col-actions-remove" value="#{cmsg.remove_membership}" tooltip="#{cmsg.remove_membership}" image="/images/icons/delete_person.gif" showLink="false" action="wai:dialog:removeUserProfileDialogWai" actionListener="#{WaiDialogManager.setupParameters}">
...
<circabc:richList id="igRoles" viewMode="circa" 
	...
	<circabc:column id="action-column">
		<circabc:actionLink id="view-user-membership-col-actions-remove" value="#{cmsg.remove_membership}" tooltip="#{cmsg.remove_membership}" image="/images/icons/delete_person.gif" showLink="false" action="wai:dialog:removeUserProfileDialogWai" actionListener="#{WaiDialogManager.setupParameters}">
