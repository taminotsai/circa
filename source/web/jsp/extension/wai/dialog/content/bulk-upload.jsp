					...
					<div class="contentFullPage">
						...
						<circabc:displayer id="displayer12" rendered="#{BulkUploadBean.hasBeenUploaded == false}">
							<circabc:panel id="bulkupload-main-section" styleClass="signup_rub_title">
								<h:outputText value="#{cmsg.add_content_label}" escape="false" />
							</circabc:panel>
						    ...
						    <h:form acceptcharset="UTF-8" id="Form4Principal" styleClass="FormPrincipal" >
								...
								<div class="scrollPanel">
									<circabc:panel id="upload-message-2" styleClass="signup_rub_title">
										<h:outputText value="#{cmsg.bulk_upload_check_message_2}" escape="false" />
									</circabc:panel>
									<f:verbatim><br /></f:verbatim>
									...
									<circabc:richList id="bulkErrorList" viewMode="circa" styleClass="recordSet"
										...
										<f:facet name="empty">
											<h:outputFormat id="error-empty" value="#{cmsg.bulk_upload_status_error_empty}" escape="false" styleClass="noItem"/>
										</f:facet>
									</circabc:richList>
								</div>
								...
								<div class="scrollPanel" >
									...
									<circabc:panel id="upload-message-1" styleClass="signup_rub_title">
										<h:outputText value="#{cmsg.bulk_upload_check_message_1}" escape="false" />
									</circabc:panel>
									<f:verbatim><br /></f:verbatim>
									...
									<circabc:richList id="bulkInformationList"
										...
										<f:facet name="empty">
											<h:outputFormat id="index-empty" value="#{cmsg.bulk_upload_status_index_empty}" escape="false" styleClass="noItem"/>
										</f:facet>
									</circabc:richList>
								</div>
							</h:form>
