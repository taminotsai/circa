	...
	<div id="ContentMain">
		...
		<div class="ContentMainForm">
			...
			<h:form acceptcharset="UTF-8" id="FormRemoveFile">
				...
				<h:outputText id="no-files" value="#{cmsg.library_add_content_no_uploaded_files}" escape="false" rendered="#{CircabcAddTranslationBean.uploadedFileCount == 0}" styleClass="noItem" />
		</h:form>
