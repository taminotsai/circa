...
<circabc:panel id="contentMainFormAllLinks" styleClass="contentMainForm">
	...
	<f:verbatim>
		...
		<script type="text/javascript">
			var addthis_share =
			{
				url: '${WaiDialogManager.bean.rootUrl}${WaiDialogManager.bean.browseUrl}',
				title: '${WaiDialogManager.bean.actionNode.bestTitle}',
				description: '${WaiDialogManager.bean.path}'
			}
		</script>
	...
	<circabc:panel id="nodelinks-main-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.node_links_dialog_details}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="nodelinks-second-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.node_links_dialog_urlgerenator}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="nodelinks-third-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.node_links_dialog_preview_rendered}" escape="false" />
	</circabc:panel>
	<f:verbatim><br /></f:verbatim>
	<h:panelGrid columns="2" cellpadding="3" cellspacing="3" border="0">
