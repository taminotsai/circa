...
<circabc:panel id="contentMainForm" styleClass="contentFullPage">
		...
		<h:outputFormat value="<p>" escape="false" />
			...
			<h:outputText value="#{cmsg.self_registration_page_login_text_secondpart}" escape="false" />
		...
		<circabc:panel id="signup-rub-identity" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.self_registration_page_identity}" escape="false" />
		</circabc:panel>
		...
		<circabc:panel id="signup-rub-contact-info" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.self_registration_page_contact_information}" escape="false" />
		</circabc:panel>
		...
		<circabc:panel id="signup-rub-console-info" styleClass="signup_rub_title">
			<h:outputText value="#{msg.user_console_info}" escape="false" />
		</circabc:panel>
		...
		<circabc:panel id="signup-privacy-stmt" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.self_registration_privacy_statement_title}" escape="false" />
		</circabc:panel>
