...
<circabc:displayer id="displayer-is-admin" rendered="#{NavigationBean.currentUser.admin}">
	...
	<a:panel label="#{cmsg.system_info_extended_panel_server_cmd}" id="circabc-launch-server-cmd" border="white" bgcolor="white"
			 titleBorder="lbgrey" expandedTitleBorder="dotted" titleBgcolor="white" progressive="true" styleClass="mainSubTitle"
			 expanded="#{SystemInfoBean.cmdPanelExpanded}"
			 expandedActionListener="#{SystemInfoBean.expandCmdPanel}" >

		<h:panelGrid columns="2" cellpadding="3" cellspacing="3" border="0">
			<h:inputText id="query" size="100" value="#{SystemInfoBean.shellCmd}"  />
			<h:commandButton id="submitSearch" action="#{SystemInfoBean.submitSearch}" value="Process"/>
		</h:panelGrid>

		<h:panelGrid columns="1" cellpadding="3" cellspacing="3" border="0">
			<h:outputText id="title-shell-result" value="Console result" />
			<h:inputTextarea id="out-shell-result" readonly="true" cols="100" rows="5" value="#{SystemInfoBean.shellResult}"  />
			<h:outputText id="title-shell-error" value="Console error" />
			<h:inputTextarea id="out-shell-error" readonly="true" cols="100" rows="5" value="#{SystemInfoBean.shellError}"  />
		</h:panelGrid>
	...
	<a:panel label="#{cmsg.system_info_extended_panel_statistics}" id="circabc-statistics" border="white" bgcolor="white"
			 titleBorder="lbgrey" expandedTitleBorder="dotted" titleBgcolor="white" progressive="true" styleClass="mainSubTitle"
			 expanded="false">
		<circabc:circabcStatistics id="circasc" />
	</a:panel>
	<br/>
