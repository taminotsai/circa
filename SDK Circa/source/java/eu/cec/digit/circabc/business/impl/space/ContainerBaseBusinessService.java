...
public abstract class ContainerBaseBusinessService
{
	...
	protected NodeRef createContainerImpl(final NodeRef parent, final QName type, final String title, final String description, final ContainerIcon icon, final Date expirationDate)
	{
