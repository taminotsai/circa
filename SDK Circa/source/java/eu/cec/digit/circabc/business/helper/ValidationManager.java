...
public class ValidationManager
{
	 ...
	 * @param newUserName									The userName to test, can't be null, can't be empty, can't be already in use (if new)
	 *
	 */
	public void validateUserName(final String previousUserName, final String newUserName, final BusinessStackError stack)
	{
	 ...
	 * @param newEmail									The email to test, can't be null, can't be empty, can't be already in use (if new) and must be a valid Email
	 */
	public void validateEmail(final String previousEmail, final String newEmail, final BusinessStackError stack)
	{
	...
	/**
	 * Validate if the given node is not null and is a any child of the information interest group service
	 *
	 * @param nodeRef
	 * @param stack
	 */
	...
	/**
	 * Validate if the given node is not null and is a any child of the library interest group service
	 *
	 * @param nodeRef
	 * @param stack
	 */
	...
	/**
	 * Validate if the given node is not null and is a any child of the directory interest group service
	 *
	 * @param nodeRef
	 * @param stack
	 */
	...
	/**
	 * Validate if the given node is not null and is a any child of the newsgroup interest group service
	 *
	 * @param nodeRef
	 * @param stack
	 */
	...
	/**
	 * Validate if the given node is not null and is a any child of the calendar interest group service
	 *
	 * @param nodeRef
	 * @param stack
	 */
	 ...
	 */
	private boolean validateHasText(final String mandatoryString, final BusinessStackError stack, String message)
	{
