...
/**
 * URL model aspect behaviour.
 * You should synchronize the content of the URL with its url property.
 *
 * @author David Ferraz
 */
public class UrlModelAspect implements ContentServicePolicies.OnContentUpdatePolicy, NodeServicePolicies.OnUpdatePropertiesPolicy
{

	/**
	 * content of the HTML container of an URL
	 */
	public static final String URL_FIXED_CONTENT = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">" +
		...
		if(after != null && after.containsKey(PROP_URL))
		{
			...
			if(newUrl != null && !newUrl.equals(oldUrl))
			{
			    ...
			    try
			    {
				    ...
				    {
						logger.debug("Updating URL description file"
