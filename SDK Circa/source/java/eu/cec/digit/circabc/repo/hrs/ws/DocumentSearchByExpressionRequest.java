...
public class DocumentSearchByExpressionRequest  implements java.io.Serializable {
     ...
     * 
     * @return fulltextSearchExpression   * Fulltext search expression.
     *                         Fulltext search will not retrieve documents
     * beyond the
     *                         300 limit (e.g. skip=299, max=10 will always
     * produce at most one document
     ...
     * 
     * @param fulltextSearchExpression   * Fulltext search expression.
     *                         Fulltext search will not retrieve documents
     * beyond the
     *                         300 limit (e.g. skip=299, max=10 will always
     * produce at most one document
     ...
     * 
     * @return skip   * Skip N documents. This field is used to implement a mechanism
     * of
     *                         pagination.
     */
     ...
     * 
     * @param skip   * Skip N documents. This field is used to implement a mechanism
     * of
     *                         pagination.
     */
     ...
     * 
     * @return max   * Maximum number of documents to be retrieved by the search.
     *                         If this value is greater than 300, only basic
     * metadata of the document
     *                         can be retrieved for performance reasons,
     * so specifying any options in
     ...
     * 
     * @param max   * Maximum number of documents to be retrieved by the search.
     *                         If this value is greater than 300, only basic
     * metadata of the document
     *                         can be retrieved for performance reasons,
     * so specifying any options in
     ...
     * 
     * @return additionalPartitions   * If omitted the search will be executed in the partition to
     * which the application
     *                     belongs.
     *                     If present it indicates that the search should
     * also be executed in the given
     ...
     * 
     * @param additionalPartitions   * If omitted the search will be executed in the partition to
     * which the application
     *                     belongs.
     *                     If present it indicates that the search should
     * also be executed in the given
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentSearchByExpressionRequest)) return false;
        ...
        _equals = true && 
            ...
            ((this.fulltextSearchExpression==null && other.getFulltextSearchExpression()==null) || 
            ...
            ((this.additionalPartitions==null && other.getAdditionalPartitions()==null) || 
             (this.additionalPartitions!=null &&
              java.util.Arrays.equals(this.additionalPartitions, other.getAdditionalPartitions())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "DocumentSearchByExpressionRequest"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("searchExpression");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "searchExpression"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "fulltextSearchExpression"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "additionalPartitions"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "partitionId"));
        typeDesc.addFieldDesc(elemField);
    }
