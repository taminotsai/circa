 ...
 */
public class AssignmentTaskToAdd  extends eu.cec.digit.circabc.repo.hrs.ws.TaskToAdd  implements java.io.Serializable {
     ...
     * 
     * @return code   * The code of this task, indicating what
     *                                 action the user is supposed to do
     * as part of this
     *                                 task.
     */
     ...
     * 
     * @param code   * The code of this task, indicating what
     *                                 action the user is supposed to do
     * as part of this
     *                                 task.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AssignmentTaskToAdd)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "AssignmentTaskToAdd"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("code");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "code"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">AssignmentTaskToAdd>code"));
