...
public class UserWebServiceLocator extends org.apache.axis.client.Service implements eu.cec.digit.circabc.repo.hrs.ws.UserWebService {
 ...
 */
    ...
    private java.lang.String UserService_address = "http://dighbust.cc.cec.eu.int:11031/hermes/Proxy/1.14/UserWebServicePS";
    ...
    public eu.cec.digit.circabc.repo.hrs.ws.UserService_PortType getUserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eu.cec.digit.circabc.repo.hrs.ws.UserServiceBindingStub _stub = new eu.cec.digit.circabc.repo.hrs.ws.UserServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eu.cec.digit.circabc.repo.hrs.ws.UserService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eu.cec.digit.circabc.repo.hrs.ws.UserServiceBindingStub _stub = new eu.cec.digit.circabc.repo.hrs.ws.UserServiceBindingStub(new java.net.URL(UserService_address), this);
                _stub.setPortName(getUserServiceWSDDServiceName());
                return _stub;
            }
        }
