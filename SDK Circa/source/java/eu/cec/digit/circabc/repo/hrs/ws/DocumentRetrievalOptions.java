...
/**
 * Options allowing to precise the parts of a document we need to
 * retrieve. It allows client applications to define which metadata to
 * retrieve for a document.
 */
public class DocumentRetrievalOptions  implements java.io.Serializable {
     ...
     * 
     * @return includeSendersAndRecipientsMetadata   * Specifies that the document search response will contain the
     * metadata of senders/receivers.
     *                             Equivalent to specifying both includeSenders
     * and includeRecipients.
     */
     ...
     * 
     * @param includeSendersAndRecipientsMetadata   * Specifies that the document search response will contain the
     * metadata of senders/receivers.
     *                             Equivalent to specifying both includeSenders
     * and includeRecipients.
     */
    public void setIncludeSendersAndRecipientsMetadata(java.lang.Boolean includeSendersAndRecipientsMetadata) {
        this.includeSendersAndRecipientsMetadata = includeSendersAndRecipientsMetadata;
    }
     ...
     * 
     * @return includeSenders   * Specifies that the document search response will contain the
     * metadata of senders
     */
     ...
     * 
     * @param includeSenders   * Specifies that the document search response will contain the
     * metadata of senders
     */
     ...
     * 
     * @return includeFilingInfo   * It specifies that the document search response will contain
     * filing information
     */
     ...
     * 
     * @param includeFilingInfo   * It specifies that the document search response will contain
     * filing information
     */
     ...
     * 
     * @return includeLinks   * It specifies that the document search response will contain
     * the links of the document
     */
     ...
     * 
     * @param includeLinks   * It specifies that the document search response will contain
     * the links of the document
     */
     ...
     * 
     * @return includeAssignmentWorkflow   * It specifies that the document search response should contain
     * the Assignment workflow if existing
     */
     ...
     * 
     * @param includeAssignmentWorkflow   * It specifies that the document search response should contain
     * the Assignment workflow if existing
     */
     ...
     * 
     * @return includeSignatoryWorkflow   * It specifies that the document search response should contain
     * the Signatory Paper or e-Signatory workflow if existing
     */
     ...
     * 
     * @return limitTasksToActiveTasks   * When retrieving the workflow of a document (Assignment or Signatory)
     * limit
     *                         returned tasks to those that are active.
     *                         This can be used as a performance optimization,
     * since the Assignment workflow of a document
     ...
     * 
     * @param limitTasksToActiveTasks   * When retrieving the workflow of a document (Assignment or Signatory)
     * limit
     *                         returned tasks to those that are active.
     *                         This can be used as a performance optimization,
     * since the Assignment workflow of a document
     ...
     * 
     * @return includeProcedure   * It specifies that the document search response should include
     * the procedure (if any) linked to the document
     */
     ...
     * 
     * @param includeProcedure   * It specifies that the document search response should include
     * the procedure (if any) linked to the document
     */
     ...
     * 
     * @return includeSignedBy   * Include the users that have signed the document (applies only
     * to registered documents).
     */
     ...
     * 
     * @param includeSignedBy   * Include the users that have signed the document (applies only
     * to registered documents).
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentRetrievalOptions)) return false;
        ...
        _equals = true && 
            ...
            ((this.includeSendersAndRecipientsMetadata==null && other.getIncludeSendersAndRecipientsMetadata()==null) || 
             (this.includeSendersAndRecipientsMetadata!=null &&
              this.includeSendersAndRecipientsMetadata.equals(other.getIncludeSendersAndRecipientsMetadata()))) &&
            ...
            ((this.includeAssignmentWorkflow==null && other.getIncludeAssignmentWorkflow()==null) || 
             (this.includeAssignmentWorkflow!=null &&
              this.includeAssignmentWorkflow.equals(other.getIncludeAssignmentWorkflow()))) &&
            ((this.includeSignatoryWorkflow==null && other.getIncludeSignatoryWorkflow()==null) || 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "DocumentRetrievalOptions"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("includeItemsMetadata");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeItemsMetadata"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeSendersAndRecipientsMetadata"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeSenders"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeRecipients"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeFilingInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeLinks"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeAssignmentWorkflow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeSignatoryWorkflow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "limitTasksToCurrentUser"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "limitTasksToActiveTasks"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeProcedure"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "includeSignedBy"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
