...
public class LibraryProfileManagerServiceImpl extends
		ProfileManagerServiceImpl implements LibraryProfileManagerService
{
	...
	private static final Log logger = LogFactory
			.getLog(LibraryProfileManagerServiceImpl.class);
	...
	public Profile updateProfile(final NodeRef nodeRef, final String profileName, final Map<String, Set<String>> servicesPermissions, final boolean updateProfileMap)
	{
		final String key = nodeRef.toString();
		profileMapCache.remove(key);
	...
	public Map<QName, String> getServiceRolesEnum()
	{
		...
		map.put(PermissionModel.LIBRARY_PERMISSION, CircabcServices.LIBRARY
				.toString());
		return map;
	}
