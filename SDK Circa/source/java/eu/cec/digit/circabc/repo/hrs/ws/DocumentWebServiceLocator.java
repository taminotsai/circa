...
public class DocumentWebServiceLocator extends org.apache.axis.client.Service implements eu.cec.digit.circabc.repo.hrs.ws.DocumentWebService {
 ...
 */
    ...
    public DocumentWebServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for DocumentService
    private java.lang.String DocumentService_address = "http://dighbust.cc.cec.eu.int:11031/hermes/Proxy/1.16/DocumentWebServicePS";
    ...
    public eu.cec.digit.circabc.repo.hrs.ws.DocumentService_PortType getDocumentService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eu.cec.digit.circabc.repo.hrs.ws.DocumentServiceBindingStub _stub = new eu.cec.digit.circabc.repo.hrs.ws.DocumentServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eu.cec.digit.circabc.repo.hrs.ws.DocumentService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eu.cec.digit.circabc.repo.hrs.ws.DocumentServiceBindingStub _stub = new eu.cec.digit.circabc.repo.hrs.ws.DocumentServiceBindingStub(new java.net.URL(DocumentService_address), this);
                _stub.setPortName(getDocumentServiceWSDDServiceName());
                return _stub;
            }
        }
