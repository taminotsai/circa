...
public class BypassSignatoryTaskRequest  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BypassSignatoryTaskRequest)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "BypassSignatoryTaskRequest"));
