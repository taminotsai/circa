...
public class ItemCheckinRequest  implements java.io.Serializable {
     ...
     * 
     * @return contentId   * Content id that was obtained by uploading the content
     *                         using the data transfer service
     */
     ...
     * 
     * @param contentId   * Content id that was obtained by uploading the content
     *                         using the data transfer service
     */
     ...
     * 
     * @return versioningStrategy   * Specifies whether the checkin operation should create a
     *                         new major version (e.g.  new version is 2.0),
     * a new minor version
     *                         (e.g. new version is 1.1), or should overwrite
     * the existing version
     ...
     * 
     * @param versioningStrategy   * Specifies whether the checkin operation should create a
     *                         new major version (e.g.  new version is 2.0),
     * a new minor version
     *                         (e.g. new version is 1.1), or should overwrite
     * the existing version
     ...
     * have been overwritten.
     */
    public void setVersioningStrategy(eu.cec.digit.circabc.repo.hrs.ws.ItemCheckinRequestVersioningStrategy versioningStrategy) {
        this.versioningStrategy = versioningStrategy;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ItemCheckinRequest)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "ItemCheckinRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "versioningStrategy"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">ItemCheckinRequest>versioningStrategy"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
