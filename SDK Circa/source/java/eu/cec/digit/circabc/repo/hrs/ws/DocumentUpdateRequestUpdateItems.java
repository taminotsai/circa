...
public class DocumentUpdateRequestUpdateItems  implements java.io.Serializable {
     ...
     * 
     * @return remove   * Remove all versions of the specified item from the document
     * and the repository. If the item is not found, it is silently ignored.
     */
     ...
     * 
     * @param remove   * Remove all versions of the specified item from the document
     * and the repository. If the item is not found, it is silently ignored.
     */
     ...
     * 
     * @return updateDetails   * Update the metadata of the specified item (or translation).
     * If the item is not found,
     *                                 a failure is raised. <br/>
     * 
     *                                 The update works as follows:
     ...
     * 
     * @param updateDetails   * Update the metadata of the specified item (or translation).
     * If the item is not found,
     *                                 a failure is raised. <br/>
     * 
     *                                 The update works as follows:
     ...
     *                                 </ul>
     */
    public void setUpdateDetails(eu.cec.digit.circabc.repo.hrs.ws.DocumentUpdateRequestUpdateItemsUpdateDetails[] updateDetails) {
        this.updateDetails = updateDetails;
    }

    public eu.cec.digit.circabc.repo.hrs.ws.DocumentUpdateRequestUpdateItemsUpdateDetails getUpdateDetails(int i) {
        return this.updateDetails[i];
    }

    public void setUpdateDetails(int i, eu.cec.digit.circabc.repo.hrs.ws.DocumentUpdateRequestUpdateItemsUpdateDetails _value) {
        this.updateDetails[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentUpdateRequestUpdateItems)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">DocumentUpdateRequest>updateItems"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "updateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">>DocumentUpdateRequest>updateItems>updateDetails"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
