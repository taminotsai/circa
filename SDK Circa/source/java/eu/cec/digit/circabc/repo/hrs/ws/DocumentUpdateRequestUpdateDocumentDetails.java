...
public class DocumentUpdateRequestUpdateDocumentDetails  implements java.io.Serializable {
     ...
     * 
     * @return securityClassification   * Updated document security classification. When specifying 'EU_RESTREINED',
     * you also need to remove all items if any.
     */
     ...
     * 
     * @param securityClassification   * Updated document security classification. When specifying 'EU_RESTREINED',
     * you also need to remove all items if any.
     */
     ...
     * 
     * @return marking   * Updated marker. When specifying COMP or OLAF markings, you
     * also need to remove all items.
     */
     ...
     * 
     * @param marking   * Updated marker. When specifying COMP or OLAF markings, you
     * also need to remove all items.
     */
     ...
     * 
     * @return removeMarking   * Set this element to true if you want to remove the marking
     * associated with the document. This has precedence over the marking
     * element.
     */
     ...
     * 
     * @param removeMarking   * Set this element to true if you want to remove the marking
     * associated with the document. This has precedence over the marking
     * element.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentUpdateRequestUpdateDocumentDetails)) return false;
        DocumentUpdateRequestUpdateDocumentDetails other = (DocumentUpdateRequestUpdateDocumentDetails) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DocumentUpdateRequestUpdateDocumentDetails.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">DocumentUpdateRequest>updateDocumentDetails"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "removeMarking"));
