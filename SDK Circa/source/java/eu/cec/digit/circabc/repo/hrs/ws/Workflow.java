...
public abstract class Workflow  implements java.io.Serializable {
     ...
     * 
     * @return documentId   * Internal repository ID of the document for which this workflow
     * exists
     */
     ...
     * 
     * @param documentId   * Internal repository ID of the document for which this workflow
     * exists
     */
     ...
     * 
     * @return active   * Indicates if the workflow is currently active. A workflow is
     * considered active if it has active/launched tasks.
     */
     ...
     * 
     * @param active   * Indicates if the workflow is currently active. A workflow is
     * considered active if it has active/launched tasks.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "Workflow"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "active"));
