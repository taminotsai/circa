...
/**
 * Request to create a new external entity. The external entity can
 * be
 *                 either a person or an organization. The person can
 * be linked to an organization or
 *                 not. A person can be linked to at most one organization.
 */
public class CurrentExternalEntityCreationRequest  implements java.io.Serializable {
     ...
     */
    public void setExternalPersonCreationRequest(eu.cec.digit.circabc.repo.hrs.ws.ExternalPersonCreationRequest externalPersonCreationRequest) {
        this.externalPersonCreationRequest = externalPersonCreationRequest;
    }


    /**
     * Gets the externalOrganizationCreationRequest value for this CurrentExternalEntityCreationRequest.
     * 
    ...
    /**
     * Sets the externalOrganizationCreationRequest value for this CurrentExternalEntityCreationRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CurrentExternalEntityCreationRequest)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.externalPersonCreationRequest==null && other.getExternalPersonCreationRequest()==null) || 
             (this.externalPersonCreationRequest!=null &&
              this.externalPersonCreationRequest.equals(other.getExternalPersonCreationRequest()))) &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "CurrentExternalEntityCreationRequest"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("externalPersonCreationRequest");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "externalPersonCreationRequest"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "ExternalPersonCreationRequest"));
