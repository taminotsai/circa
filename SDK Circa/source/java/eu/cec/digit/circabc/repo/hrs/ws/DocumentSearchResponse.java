...
public class DocumentSearchResponse  implements java.io.Serializable {
     ...
     * 
     * @return totalRetrievable   * The number of documents that can be retrieved.
     *                                    For performance reasons this is
     * limited to 2000 (even if there are
     *                                    more documents in the repository
     * to match the expression).
     ...
     * 
     * @param totalRetrievable   * The number of documents that can be retrieved.
     *                                    For performance reasons this is
     * limited to 2000 (even if there are
     *                                    more documents in the repository
     * to match the expression).
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentSearchResponse)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "DocumentSearchResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("totalRetrievable");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "totalRetrievable"));
