...
public class FindCurrentInternalEntityRequest  implements java.io.Serializable {
     ...
     */
    public void setSearchForPerson(eu.cec.digit.circabc.repo.hrs.ws.FindCurrentInternalEntityRequestSearchForPerson searchForPerson) {
        this.searchForPerson = searchForPerson;
    }
     ...
     */
    public void setSearchForOrganization(eu.cec.digit.circabc.repo.hrs.ws.FindCurrentInternalEntityRequestSearchForOrganization searchForOrganization) {
        this.searchForOrganization = searchForOrganization;
    }
     ...
     * 
     * @return searchById   * Search for up to 50 current entities given their repository
     * ids
     */
     ...
     * 
     * @param searchById   * Search for up to 50 current entities given their repository
     * ids
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindCurrentInternalEntityRequest)) return false;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "FindCurrentInternalEntityRequest"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("searchForPerson");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "searchForPerson"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">FindCurrentInternalEntityRequest>searchForPerson"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("searchForOrganization");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "searchForOrganization"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", ">FindCurrentInternalEntityRequest>searchForOrganization"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("searchById");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "searchById"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "CurrentEntityId"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "currentEntityId"));
        typeDesc.addFieldDesc(elemField);
    }
