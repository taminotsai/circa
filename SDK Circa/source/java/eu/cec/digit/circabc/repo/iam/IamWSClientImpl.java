...
public class IamWSClientImpl implements IamWSClient {
	...
	private static final String DATA_TEMPLATE_GRANT_THEM_ROLE = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\r\n" + 
	...
	private static final String DATA_TEMPLATE_REVOKE_THEM_ROLE = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\r\n" + 
	"<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"\r\n" + 
	"	xmlns:v3=\"http://ec.europa.eu/rdg/efp/services/iam/research-theme/interfaces/V3\">\r\n" + 
	"	<soap:Header>\r\n" + 
	"		<wsse:Security\r\n" + 
	...
	private void callWebService(String userID, String themeID, String roleID, String dataTemplate)
	{
		...
		String data = String.format(dataTemplate, user,digest,nonceEncoded,created,userID,themeID,roleID);
