...
public interface CircabcRootProfileManagerService extends ProfileManagerService
{
	public interface Profiles
	{
		...
		public static final String CIRCABC_ADMIN = "CircaBCAdmin";
	}

	public interface Roles
	{
	}
	public static final String ALL_CIRCA_USERS_AUTHORITY = "GROUP_EVERYONE";

	public static String SERVICE_NAME = "circabcRootProfileManagerService";

	public static String PROXIED_SERVICE_NAME = "CircabcRootProfileManagerService";
	...
	public void setAlfrescoAdminPermissions(final NodeRef nodeRef, final Set<String> permissions, final boolean access);
