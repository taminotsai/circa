...
public class ProfileManagerServiceFactory implements BeanFactoryAware
{
	...
	/**
	 * Depending the Aspect applied to the NodeRef, the factory will return the
	 * appropriate instance of ProfileManagerService
	 *
	 * @param node
	 * @return
	 */
	...
	public CircabcRootProfileManagerService getCircabcRootProfileManagerService()
	{
		if (secure)
		{
			return (CircabcRootProfileManagerService) this.factory.getBean(CircabcRootProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (CircabcRootProfileManagerService) this.factory.getBean(CircabcRootProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public CategoryProfileManagerService getCategoryProfileManagerService()
	{
		...
		if (secure)
		{
			return (CategoryProfileManagerService) this.factory.getBean(CategoryProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (CategoryProfileManagerService) this.factory.getBean(CategoryProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public IGRootProfileManagerService getIGRootProfileManagerService()
	{
		if (secure)
		{
			return (IGRootProfileManagerService) this.factory.getBean(IGRootProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (IGRootProfileManagerService) this.factory.getBean(IGRootProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public LibraryProfileManagerService getLibraryProfileManagerService()
	{
		if (secure)
		{
			return (LibraryProfileManagerService) this.factory.getBean(LibraryProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (LibraryProfileManagerService) this.factory.getBean(LibraryProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public NewsGroupProfileManagerService getNewsGroupProfileManagerService()
	{
		if (secure)
		{
			return (NewsGroupProfileManagerService) this.factory.getBean(NewsGroupProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (NewsGroupProfileManagerService) this.factory.getBean(NewsGroupProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public SurveyProfileManagerService getSurveyProfileManagerService()
	{
		if (secure)
		{
			return (SurveyProfileManagerService) this.factory.getBean(SurveyProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (SurveyProfileManagerService) this.factory.getBean(SurveyProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public InformationProfileManagerService getInformationProfileManagerService()
	{
		if (secure)
		{
			return (InformationProfileManagerService) this.factory.getBean(InformationProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (InformationProfileManagerService) this.factory.getBean(InformationProfileManagerService.SERVICE_NAME);
		}
	}
	...
	public EventProfileManagerService getEventProfileManagerService()
	{
		if (secure)
		{
			return (EventProfileManagerService) this.factory.getBean(EventProfileManagerService.PROXIED_SERVICE_NAME);
		}
		else
		{
			return (EventProfileManagerService) this.factory.getBean(EventProfileManagerService.SERVICE_NAME);
		}
	}
	...
	/**
	 * Setter method for secure This help to chose if ProfileManeger has to bo
	 * proxied or not.
	 *
	 * @param secure
	 *            the use proxy or not
	 */
	...
	/**
	 * Getter that help to get the BeanName This should be used only if IOC
