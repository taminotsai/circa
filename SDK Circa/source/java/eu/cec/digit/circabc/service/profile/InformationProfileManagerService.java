...
public interface InformationProfileManagerService extends ProfileManagerService
{
	...
	public interface Profiles extends IGRootProfileManagerService.Profiles
	{
		// Nothing new in this place at moment
	}

	public interface Roles extends IGRootProfileManagerService.Roles
	{
		// Nothing new in this place at moment
	}

	public static String SERVICE_NAME = "informationProfileManagerService";

	public static String PROXIED_SERVICE_NAME = "InformationProfileManagerService";
	...
	public void addProfile(final NodeRef nodeRef, final String profileName, final String authorityGroupName,
			final Map<String, Set<String>> servicesPermissions) throws ProfileException;
