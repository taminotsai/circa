 ...
 *
 * This tag collects the user params needed to specify an Input component to allow the user to enter a date. It specifies the renderer as below to be our Date specific renderer.
 *
 * @author Guillaume
 */
public class InputDatePickerTag extends HtmlComponentTag
{
	...
	/**
	 * Sets whether today's date should be shown initially if the underlying model value is null. This will also hide the None button thus disallowing the user to set the date back to null.
	 *
