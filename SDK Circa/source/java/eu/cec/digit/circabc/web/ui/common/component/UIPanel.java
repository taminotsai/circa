      ...
      if (this.hasLabel)
      {
         // start the containing div if we have any adornments
          ...
          if (this.tooltip != null) {
        	  out.write(UtilsCircabc.buildImageTag(context, WebResourcesCircabc.PUCE_PANEL, this.tooltip, this.tooltip, this.styleClassLabel));
          } else {
        	  out.write(UtilsCircabc.buildImageTag(context, WebResourcesCircabc.PUCE_PANEL, ".", ".", this.styleClassLabel));
          }
          out.write(label);
