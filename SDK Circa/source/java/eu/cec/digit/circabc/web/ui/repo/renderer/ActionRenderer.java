...
public class ActionRenderer extends BaseRenderer {
     ...
     * @throws IOException
     */
    protected void renderCommandLinkStart(FacesContext context,	UIComponent component, String clientId)
        throws IOException {
    	logger.info("ActionLink : encodeBegin - renderCommandLinkStart - Start");
        UIActionLink link = (UIActionLink) component;
        ...
        String tittle= attrs.get("tooltip")!=null?attrs.get("tooltip").toString():(String)link.getValue();
    ...
    protected String renderNonJavaScriptAnchorStart(FacesContext facesContext, ResponseWriter writer,
         ...
         if (attrs.get("href") != null) {
             ...
             String hiddenFieldName = HtmlRendererUtils.getHiddenCommandLinkFieldName(RendererUtils.findNestingForm(
...
//		 see https://webgate.ec.europa.eu/CITnet/jira/browse/DIGIT-CIRCABC-2224
     ...
     * @throws IOException
     */
    private void addChildParametersToHref(UIComponent linkComponent, StringBuffer hrefBuf, String charEncoding)
        throws IOException {
     ...
     * @throws IOException
     */
    private static void addParameterToHref(String name, Object value, StringBuffer hrefBuf, String charEncoding)
	...
	// ------------------------------------------------------------------------------
	   ...
	   private static UIComponent getVerticalContainer(UIActionLink link)
	   {
	      ...
	      while (parent != null)
	      {
	         if (parent instanceof UIMenu || (parent instanceof UIActions && ((UIActions)parent).isVerticalAlign()))
	         {
	            break;
	         }
