...
public class ActionLinkRenderer extends BaseRenderer
{
	...
	public void decode(FacesContext context, UIComponent component)
	{
		...
		if (clientId.indexOf("_________") > -1)
		{
		...
		if ((reqValue != null) && (reqValue.indexOf("_________") > -1))
		{
			// Sub link -> feinte power
	 ...
	 * @throws IOException
	 */
	public static void renderCommandLinkStart(FacesContext context, UIComponent component, String clientId) throws IOException
	{
		if (logger.isInfoEnabled())
		{
		...
		{
			writer = (ResponseWriter) new HtmlResponseWriterImpl(new StringWriter(), null, null);
		} else
		{
	 ...
	 * @throws IOException
	 */
	protected static String renderNonJavaScriptAnchorStart(FacesContext facesContext, ResponseWriter writer, UIComponent component, String clientId) throws IOException
	{
		if (logger.isInfoEnabled())
		{
			logger.info("ActionLink : encodeBegin - renderCommandLinkStart - renderNonJavaScriptAnchorStart - Start");
		}
...
//		 see https://webgate.ec.europa.eu/CITnet/jira/browse/DIGIT-CIRCABC-2224
		if (href.startsWith("/circabc/d/") || href.startsWith("/circabc/sd/"))
		{
		...
		if (logger.isInfoEnabled())
		{
			logger.info("ActionLink : encodeBegin - renderCommandLinkStart - renderNonJavaScriptAnchorStart - End");
		}
	 ...
	 * @throws IOException
	 */
	private static void addChildParametersToHref(UIComponent linkComponent, StringBuffer hrefBuf, String charEncoding) throws IOException
	{
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException
	{
		...
		HtmlFormRendererBase.renderScrollHiddenInputIfNecessary(RendererUtils.findNestingForm(component, context).getForm(), context, context.getResponseWriter());
		if (logger.isInfoEnabled())
		{
