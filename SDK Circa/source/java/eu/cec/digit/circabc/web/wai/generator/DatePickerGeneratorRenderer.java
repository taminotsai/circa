...
//				 TODO: should check for disabled/readonly here - no need to decode
		...
		if (component.isRendered())
		{
			...
			Date date = null;
	         ...
	         if (date != null)
	         {
	            ...
	            int nStartYear = getDateFromAttributes(context, "startYear", component.getAttributes(), DEFAULT_START_YEAR);

	            int nYearCount = getDateFromAttributes(context, "yearCount", component.getAttributes(), DEFAULT_YEAR_COUNT);
	...
	private int getDateFromAttributes(FacesContext context, String key, Map attributes, int defaultValue)
	{
