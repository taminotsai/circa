...
public class DeletePropertyDialog extends BaseWaiDialog {
	...
	public void init(Map<String, String> parameters)
	{
		...
		if(parameters != null)
		{
			...
			{
				throw new IllegalArgumentException("Impossible to delete the property if the property parameters is not seted: " + ManagePropertiesDialog.PROPERTY_PARAMETER);
			}

			propertyToDelete = this.getPropertiesService().getDynamicPropertyByID(new NodeRef(propertyAsString));
		}
	}
	...
	protected String finishImpl(FacesContext context, String outcome) throws Exception
	{
		try
		{
			String info =MessageFormat.format("the property {0} has been deleted", new Object[]{propertyToDelete.getName()});
