...
public class UISortLink extends UICommand
{
	...
	{
		if(logger.isInfoEnabled()) {
			logger.info("SortLink : encodeBegin - renderCommandLinkStart - renderNonJavaScriptAnchorStart - Start");
		}
		...
		if(logger.isInfoEnabled()) {
			logger.info("SortLink : encodeBegin - renderCommandLinkStart - renderNonJavaScriptAnchorStart - End");
		}
	}
	 ...
	 *
	 * @param sortMode
	 *            the sorting mode- see IDataContainer constants
	 */
	 ...
	 *            The tooltipDescending to set.
	 */
	public void setTooltipDescending(String tooltipDescending)
	{
		this.tooltip = tooltipDescending;
	}
