...
/**
 * Base generator can be used in the edit properties dialog to launch a dialog. The property will be read only.
 *
...
public abstract class BaseDialogLauncherGenerator extends BaseComponentGenerator
{
	...
	public UIComponent generate(FacesContext context, String id)
	{
		...
		UIComponent panel = context.getApplication().createComponent("eu.cec.digit.circabc.faces.Panel");
	...
	protected List<UIParameter> getActionParameters(final FacesContext context, final String id)
	{
		...
		UIParameter parmeterNodeId = (UIParameter)context.getApplication().createComponent(UIParameter.COMPONENT_TYPE);
		...
		//add the parameter id to the dialog
		UIParameter parmeterPropId = (UIParameter)context.getApplication().createComponent(UIParameter.COMPONENT_TYPE);
		...
		final List<UIParameter> parameters = new ArrayList<UIParameter>(4);
	...
	protected UICommand buildActionCommand(final FacesContext context, final String id)
	{
		...
		HtmlCommandButton picker = (HtmlCommandButton) context.getApplication().createComponent(HtmlCommandButton.COMPONENT_TYPE);
