...
public final class UtilsCircabc
{
     ...
     */
    public static String buildImageTag(FacesContext context, String image, String alt, String title, String styleClass, String imageName)
    {
     ...
     * @return Populated <code>img</code> tag
     */
    public static String buildImageTag(FacesContext context, String image, String alt, String title, String styleClass)
    {
     ...
     */
    public static String generateHrefPart(FacesContext context, UIComponent component, String id, Map<String, String> attributes)
    {
        ...
        String hiddenFieldName = HtmlRendererUtils.getHiddenCommandLinkFieldName(RendererUtils.findNestingForm(component, context));
     ...
     * @return
     */
    public static String getFirstLines(final String text, final String separator, final int lineNumer)
    {
    ...
    public static QName getPropContent(QName typeQName) {
    	...
    	return CircabcModel.TYPE_CUSTOMIZATION_CONTENT.equals(typeQName) ? 
				CircabcModel.PROP_CONTENT : (DocumentModel.TYPE_HIDDEN_ATTACHEMENT_CONTENT.equals(typeQName) ? 
