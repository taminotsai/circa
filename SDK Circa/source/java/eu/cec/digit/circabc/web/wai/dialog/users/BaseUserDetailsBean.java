...
public abstract class BaseUserDetailsBean extends BaseWaiDialog
{
	 ...
	 *
	 * @param parameters 				The parameters to initialize the bean (not used here)
	 */
	@Override
	...
	public String getProfileUrl()
	{
		...
		{
			return WebClientHelper.getGeneratedWaiFullUrl(userDetails.getNodeRef(), ExtendedURLMode.HTTP_USERDETAILS);
		}
		else
		{
			return "N/A";
	...
	/**
	 * Getter for the list of items for the content filtering language selection include the label 'all langaguages'
	 *
	...
	{
		return WebClientHelper.getGeneratedWaiUrl(userDetails.getAvatar(), ExtendedURLMode.HTTP_DOWNLOAD, true);
	}
