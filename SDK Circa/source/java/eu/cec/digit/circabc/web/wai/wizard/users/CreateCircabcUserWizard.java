...
import eu.cec.digit.circabc.web.validator.FirstNameValidator;
import eu.cec.digit.circabc.web.validator.LastNameValidator;
import eu.cec.digit.circabc.web.validator.PasswordValidator;
import eu.cec.digit.circabc.web.validator.PhoneValidator;
import eu.cec.digit.circabc.web.validator.PostalAddressValidator;
import eu.cec.digit.circabc.web.validator.UserNameValidator;
import eu.cec.digit.circabc.web.wai.wizard.BaseWaiWizard;

/**
 * @deprecated	Please to delete this class when the show person properties dialog <b>(viewUserDialogWai)</b> will be refractored
 *
 * @author Ph Dubois
 */
...
public class CreateCircabcUserWizard extends BaseWaiWizard
{
    ...
    public void init(Map<String, String> params)
    {
    	...
    	if(editParam != null
    			&& Boolean.valueOf(editParam).booleanValue())
    	{
	...
	protected String editPerson(final String outcome) throws Exception
	{
    	...
    	final RetryingTransactionCallback<Object> callback = new RetryingTransactionCallback<Object>()
    	{
    		public Object execute() throws Throwable
    		{
	    		...
	    		getUserService().setPreference(person, UserService.PREF_INTERFACE_LANGUAGE, userInterfaceLanguage);
	...
	protected String createPerson(final FacesContext context, final String outcome, final boolean enabled) throws Exception
	{
		String newOutcome = outcome;
        ...
        if (this.password.equals(this.confirm))
        {
        	...
        	final RetryingTransactionCallback<Object> callback = new RetryingTransactionCallback<Object>()
        	{
        		public Object execute() throws Throwable
        		{
                    ...
                    getUserService().setPreference(newPerson, UserService.PREF_CONTENT_FILTER_LANGUAGE, language );
                    getUserService().setPreference(newPerson, UserService.PREF_INTERFACE_LANGUAGE, userInterfaceLanguage);
     ...
     * @param value
     */
    public void setPrefValue(final NodeRef preferenceRef, final String name, final Serializable value)
    {
    ...
    public String getSummary()
    {
    	...
    	final RetryingTransactionCallback<String> callback = new RetryingTransactionCallback<String>()
		{
			...
			{
				final NodeRef homeRef = getProfileManagerServiceFactory().getProfileManagerService(getActionNode().getNodeRef()).getCircaHome(getActionNode().getNodeRef());
	            final String homeSpaceLabel = (String) getNodeService().getProperty(homeRef, ContentModel.PROP_NAME);
    ...
    /**
	 * Manually launch each validator to have messages correctly.
	 * Fill the error map with the field in key and the translated error in value,
	 *
	 * @return if error was found
	 */
	protected boolean validateFields(final boolean validateUsername, final boolean validatePassword, final boolean validateMadatotyProperties, final boolean addFacesErrorMessages)
	{
		final FacesContext context = FacesContext.getCurrentInstance();
		this.validationErrors = new HashMap<String, String>(10);
    ...
    /**
     * call the init method to reinitialise the fields of the wizard (it is a
     * session wiward)
     */
	 ...
	 */
	public final void setAuthenticationService(final MutableAuthenticationService authenticationService)
	{
