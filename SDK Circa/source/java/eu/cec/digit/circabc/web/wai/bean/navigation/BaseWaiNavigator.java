...
public abstract class BaseWaiNavigator implements WaiNavigator
{
		...
		{
			return WebClientHelper.getGeneratedWaiRelativeUrl(getCurrentNode(), ExtendedURLMode.HTTP_WAI_BROWSE);
		}

		public String getPreviousHttpUrl()
		{
			return WebClientHelper.getGeneratedWaiRelativeUrl(getPreviousNode(), ExtendedURLMode.HTTP_WAI_BROWSE);
		}
	   ...
	   */
	   ...
	   protected final ManagementService getManagementService()
	   {
	      ...
	      {
	         this.managementService = Services.getCircabcServiceRegistry(FacesContext.getCurrentInstance()).getManagementService();
	      }
	   ...
	   protected final NodeService getNodeService()
	   {
	      ...
	      {
	         this.nodeService = Services.getAlfrescoServiceRegistry(FacesContext.getCurrentInstance()).getNodeService();
	      }
	   ...
	   protected final FileFolderService getFileFolderService()
	   {
	      ...
	      {
	         this.fileFolderService = Services.getAlfrescoServiceRegistry(FacesContext.getCurrentInstance()).getFileFolderService();
	      }
	   ...
	   protected final SearchService getSearchService()
	   {
	      ...
	      {
	         this.searchService = Services.getAlfrescoServiceRegistry(FacesContext.getCurrentInstance()).getSearchService();
	      }
	   ...
	   protected final NamespaceService getNamespaceService()
	   {
	      ...
	      {
	         this.namespaceService = Services.getAlfrescoServiceRegistry(FacesContext.getCurrentInstance()).getNamespaceService();
	      }
	   ...
	   protected final PermissionService getPermissionService()
	   {
	      ...
	      {
	         this.permissionService = Services.getAlfrescoServiceRegistry(FacesContext.getCurrentInstance()).getPermissionService();
	      }
