...
public class ManageApplicantDialog extends BaseWaiDialog
{
	...
	public List<Applicant> getApplicants()
	{
		...
		ProfileManagerService profManagerService = getProfileManagerServiceFactory().getProfileManagerService(space);
		...
		{
			return Collections. <Applicant>emptyList();
		}
		else
		{
			return new ArrayList<Applicant>(applicantsMap.values());
		}
	}
