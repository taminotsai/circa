...
public class DeleteAccessProfilesDialog extends BaseWaiDialog
{
    ...
    public void init(Map<String, String> arg0)
    {
        ...
        else if(profileDisplayTitle == null || profileName == null)
        {
        	...
        	profileName = null;
        	imported = null;
        	throw new IllegalArgumentException("Missing arguments: " + PARAM_PROFILE_NAME + " and " + PARAM_USED_TITLE + " are required!");
        }
    ...
    protected String finishImpl(FacesContext context, String outcome) throws Throwable
    {
    	try
    	{
    		final IGRootProfileManagerService profileManagerService = getProfileManagerServiceFactory().getIGRootProfileManagerService();
