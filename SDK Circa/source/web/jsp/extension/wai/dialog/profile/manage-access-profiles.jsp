...
<circabc:panel id="contentMainFormEditProfiles" styleClass="contentMainForm">
	...
	<circabc:panel id="dit-profiles-first-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_circabc_ig_profiles_section_1}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="dit-profiles-fourd-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_circabc_ig_profiles_section_4}" escape="false" />
	</circabc:panel>
	...
	<h:panelGrid columns="3" cellpadding="3" cellspacing="3" border="0">
		...
		<h:outputFormat id="activate-guest" value="#{cmsg.public_access_profile_status}" escape="false" >
		...
		<h:outputFormat id="activate-registred" value="#{cmsg.registred_access_profile_status}" escape="false" >
				<circabc:param value="#{NavigationBean.currentIGRoot.name}" />
		</h:outputFormat>
	...
	<circabc:panel id="dit-profiles-second-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_circabc_ig_profiles_section_2}" escape="false" />
	</circabc:panel>
	<f:verbatim><br /></f:verbatim>
	...
	<h:outputText id="no-profile" value="#{cmsg.edit_circabc_ig_profiles_section_2_no_profile}" escape="false" rendered="#{ManageAccessProfilesDialog.profilesDataModel.rowCount == 0}" styleClass="noItem" />
	...
	<circabc:panel id="dit-profiles-third-section" styleClass="signup_rub_title" >
		<h:outputText value="#{cmsg.edit_circabc_ig_profiles_section_3}" escape="false" />
	</circabc:panel>
	...
	<h:outputText id="no-imported" value="#{cmsg.edit_circabc_ig_profiles_section_3_no_imported}" escape="false" rendered="#{ManageAccessProfilesDialog.importedProfilesDataModel.rowCount == 0}" styleClass="noItem" />
