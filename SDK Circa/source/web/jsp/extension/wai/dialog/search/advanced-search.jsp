...
<circabc:panel id="contentMainFormAdvancedSearch" styleClass="contentMainForm">
	...
	<circabc:panel id="panelAdvSearchLookin" label="#{msg.look_in}" styleClass="panelLibraryContentGlobal" styleClassLabel="panelLibraryContentLabel" tooltip="#{msg.look_in}" rendered="false" >
	...
	<circabc:panel id="topOfPageAnchorAdvSearch-2" styleClass="topOfPageAnchor" rendered="false" >
	...
	<circabc:panel id="panelAdvAdditOptions" label="#{msg.additional_options}" styleClass="panelLibraryContentGlobal" styleClassLabel="panelLibraryContentLabel" tooltip="#{msg.additional_options_tooltip}" >
		...
		<h:panelGrid columns="2" cellpadding="3" cellspacing="3" border="0" >
			...
			<circabc:panel id="add-keyword-selection-subpanel">
				<h:outputText value="#{CircabcAdvancedSearchDialog.displayKeywords}" id="keywordsString" escape="false"/>
			...
			<h:outputText value="#{cmsg.status}&nbsp;:" id="status" escape="false"/>
