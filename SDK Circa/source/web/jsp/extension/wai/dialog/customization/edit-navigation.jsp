...
<circabc:panel id="contentMainFormManageNavCustomization" styleClass="contentMainForm">
	...
	<circabc:panel id="edit-navigation-breadcrumb_display" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_navigation_dialog_section_breadcrumb_title}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="edit-navigation-mandatoryCol-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_navigation_dialog_section_mandatory_col}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="edit-navigation-otherCol-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_navigation_dialog_section_other_col}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="edit-navigation-actions-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_navigation_dialog_section_actions}" escape="false" />
	</circabc:panel>
	...
	<circabc:panel id="edit-navigation-misc-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.edit_navigation_dialog_section_misc}" escape="false" />
	</circabc:panel>
	...
	<h:panelGrid columns="3" cellpadding="3" cellspacing="3" border="0">
		...
		<h:outputText value="#{cmsg.edit_navigation_dialog_sort_column}:" escape="false" />
		...
		<h:outputText value="#{cmsg.edit_navigation_dialog_sort_descending}:" escape="false" />
		<h:selectBooleanCheckbox value="#{DialogManager.bean.sortDescending}" />
		<h:outputText value="" escape="false" />

		<h:outputText value="#{cmsg.edit_navigation_dialog_list_size}:" escape="false" />
