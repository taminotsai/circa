...
<circabc:panel id="contentMainFormManageIgLogoCustomization" styleClass="contentMainForm">
	...
	<circabc:panel id="manage-iglogo-uploadlogo-section-file" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.manage_iglogo_dialog_define_ighome_addnew_logo_comp}" escape="false"  />
	</circabc:panel>
	...
	<circabc:panel id="manage-iglogo-uploadlogo-section-repo" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.manage_iglogo_dialog_define_ighome_addnew_logo_lib}" escape="false"  />
	</circabc:panel>
	...
	<circabc:panel id="manage-iglogo-alllogos-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.manage_iglogo_dialog_define_ighome_select_logo}" escape="false" />
	</circabc:panel>
	...
	<h:dataTable id="allLogosTable" value="#{DialogManager.bean.logosDataModel}" var="logo"
		...
		<h:column id="logo-diaplay-col">
			<f:facet name="header">
				<h:outputText id="logo-display-title" value="#{cmsg.manage_iglogo_dialog_preview}" escape="false" styleClass="logoInList"/>
			</f:facet>
	...
	<circabc:displayer rendered="#{DialogManager.bean.homeConfigAllowed}">
		...
		<circabc:panel id="manage-iglogo-mainpage-section" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.manage_iglogo_dialog_define_ighome_logo_display}" escape="false" />
		</circabc:panel>

		<h:panelGrid columns="3" cellpadding="3" cellspacing="3" border="0" >
			<h:outputText value="#{cmsg.manage_iglogo_dialog_display}:" escape="false" />
			...
			<h:outputText value="#{cmsg.manage_iglogo_dialog_atleft}:" escape="false" />
			<h:selectBooleanCheckbox value="#{DialogManager.bean.mainPageLogoAtLeft}" disabled="#{DialogManager.bean.logoSelected == false}"/>
			<h:outputText value="#{cmsg.manage_iglogo_dialog_atleft_desc}" escape="false" style="font-style: italic;"/>

			<h:outputText value="#{cmsg.manage_iglogo_dialog_width}:" escape="false" />
			<h:inputText value="#{DialogManager.bean.mainPageLogoWidth}" disabled="#{DialogManager.bean.logoSelected == false}"/>
			<h:outputText value="#{cmsg.manage_iglogo_dialog_width_desc}" escape="false" style="font-style: italic;"/>

			<h:outputText value="#{cmsg.manage_iglogo_dialog_height}:" escape="false" />
			<h:inputText value="#{DialogManager.bean.mainPageLogoHeight}" disabled="#{DialogManager.bean.logoSelected == false}"/>
			<h:outputText value="#{cmsg.manage_iglogo_dialog_height_desc}" escape="false" style="font-style: italic;"/>

			<h:outputText value="#{cmsg.manage_iglogo_dialog_force}:" escape="false" />
			<h:selectBooleanCheckbox value="#{DialogManager.bean.mainPageSizeForced}" disabled="#{DialogManager.bean.logoSelected == false}"/>
			<h:outputText value="#{cmsg.manage_iglogo_dialog_force_desc}" escape="false" style="font-style: italic;"/>
	...
	<circabc:panel id="manage-iglogo-otherpages-section" styleClass="signup_rub_title">
		<h:outputText value="#{cmsg.manage_iglogo_dialog_define_allpages_logo_display}" escape="false" />
	</circabc:panel>
	...
	<h:panelGrid columns="3" cellpadding="3" cellspacing="3" border="0" >
		...
		<h:outputText value="#{cmsg.manage_iglogo_dialog_not_editable}" escape="false" style="font-style: italic;"/>
	...
	<circabc:displayer rendered="#{DialogManager.bean.serviceConfigAllowed}">
		...
		<circabc:panel id="manage-iglogo-service-section" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.manage_iglogo_dialog_define_services_logo_display}" escape="false" />
		</circabc:panel>
		...
		<h:dataTable id="allServicesTable" value="#{DialogManager.bean.servicesDataModel}" var="serv"
			...
			<h:column id="service-name-col">
				<f:facet name="header">
					<h:outputText id="service-name-title" value="#{cmsg.service}" escape="false" styleClass="logoInList"/>
				</f:facet>
			...
			<h:column id="service-over-col">
				<f:facet name="header">
					<h:outputText id="service-over-title" value="#{cmsg.manage_iglogo_dialog_override}" escape="false" styleClass="logoInList"/>
				</f:facet>
				<h:outputText id="service-over" value="#{serv.overrided}" converter="javax.faces.Boolean"/>
			</h:column>

			<h:column id="service-display-col">
				<f:facet name="header">
					<h:outputText id="service-display-title" value="#{cmsg.manage_iglogo_dialog_display}" escape="false" styleClass="logoInList"/>
				</f:facet>
			...
			<h:column id="service-logo-col">
				<f:facet name="header">
					<h:outputText id="service-logo-title" value="#{cmsg.manage_iglogo_dialog_logo}" escape="false" styleClass="logoInList"/>
				</f:facet>
