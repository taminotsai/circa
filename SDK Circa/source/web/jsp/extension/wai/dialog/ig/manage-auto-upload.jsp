...
<f:verbatim></h3></f:verbatim>
			...
			<h:dataTable id="configurations" styleClass="recordSet" value="#{ManageAutoUploadDialog.listOfConfigurations}" var="wn" >
				...
				<h:column id="config_status">
					<f:facet name="header">
						<h:outputText id="header_config_status" value="#{cmsg.manage_auto_upload_status_list_title}" escape="false" />
					</f:facet>
				...
				<h:column id="config_path_col">
					<f:facet name="header">
						<h:outputText id="header_config_path" value="#{cmsg.manage_auto_upload_path_list_title}" escape="false" />
					</f:facet>
				...
				<h:column id="config_file_col">
					<f:facet name="header">
						<h:outputText id="header_config_file" value="#{cmsg.manage_auto_upload_filename}" escape="false" />
					</f:facet>
				...
				<h:column id="config_host_col">
					<f:facet name="header">
						<h:outputText id="header_config_host" value="#{cmsg.manage_auto_upload_host_list_title}" escape="false" />
					</f:facet>
				...
				<h:column id="config_notification">
					<f:facet name="header">
						<h:outputText id="header_config_notification" value="#{cmsg.manage_auto_upload_notify}" escape="false" />
					</f:facet>
				...
				<h:column id="config_auto_extract">
					<f:facet name="header">
						<h:outputText id="header_config_auto_extract" value="#{cmsg.manage_auto_upload_auto_extract_simple}" escape="false" />
					</f:facet>
				...
				<h:column id="config_date_restriction">
					<f:facet name="header">
						<h:outputText id="header_date_restriction" value="#{cmsg.manage_auto_upload_date_restriction}" escape="false" />
					</f:facet>
				...
				<h:column id="config_actions">
					<f:facet name="header">
						<h:outputText id="header_config_actions" value="#{cmsg.manage_auto_upload_actions}" escape="false" />
					</f:facet>
			...
			<fieldset class="formArea">
				...
				<h:outputText value="#{cmsg.configure_auto_upload_dialog_fieldset_legend }"></h:outputText><f:verbatim>	</legend></f:verbatim>
				...
				<h:inputText styleClass="textNormalWidth" id="host" value="#{ManageAutoUploadDialog.host }"></h:inputText><f:verbatim><br/></f:verbatim>
				
				<h:outputLabel value="#{cmsg.configure_auto_upload_dialog_ftp_port }" for="port"/>
				<h:inputText styleClass="textNormalWidth" id="port" value="#{ManageAutoUploadDialog.port }"></h:inputText><f:verbatim><br/></f:verbatim>
				
				<f:verbatim><br/></f:verbatim>
				
				<h:outputLabel value="#{cmsg.configure_auto_upload_dialog_ftp_path }" for="path"/>
				<h:inputText styleClass="textLongWidth" id="path" value="#{ManageAutoUploadDialog.path }"></h:inputText><f:verbatim><br/></f:verbatim>
			<f:verbatim>	<br/></f:verbatim>
				
				<h:outputLabel value="#{cmsg.configure_auto_upload_dialog_ftp_username }" for="username"/>
				<h:inputText styleClass="textNormalWidth" id="username" value="#{ManageAutoUploadDialog.username }"></h:inputText><f:verbatim><br/></f:verbatim>
				
				<h:outputLabel value="#{cmsg.configure_auto_upload_dialog_ftp_password }" for="password"/>
				<h:inputSecret styleClass="textNormalWidth" id="password" value="#{ManageAutoUploadDialog.password }" redisplay="true"></h:inputSecret><f:verbatim><br/></f:verbatim>
				...
				<h:outputText escape="false" value="#{cmsg.configure_auto_upload_dialog_test_connection_failed }" rendered="#{ManageAutoUploadDialog.testResult == -2 }"></h:outputText>
