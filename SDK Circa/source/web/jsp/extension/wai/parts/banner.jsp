     	      ...
     	      <div id="linkBoxArrow"></div>
                   ...
                   <div id="langsSelector">
                      <script type="text/javascript" language="JavaScript">
							document.write('<h:selectOneMenu style="font-size:9px;" id="language" value="#{UserPreferencesBean.language}" onchange="document.forms[0].submit(); return true;"><f:selectItems value="#{UserPreferencesBean.languages}" /></h:selectOneMenu>');
						</script>
        ...
        <div id="path">
            <div>
                <ul>
					...
					&gt;
                    <li>
						<circabc:actionLink value="${cmsg.banner_circabc}" actionListener="#{BrowseBean.clickCircabcHome}" tooltip="${cmsg.banner_circabc}" onclick="showWaitProgress();"/>
					</li>
